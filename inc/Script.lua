...
return "✯ 𓏪 *│* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n"
end
redis:set(bita.."getidstatus"..msg.chat_id_, "Simple")
return  "✯ 𓏪 ** أهلا عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** تم تعطيل الايدي بالصوره  \n" 
end 
...
return  "✯ 𓏪 ** أهلا عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** تم تفعيل الايدي بالصوره \n" 
end
function cmds_on(msg)
if not msg.Creator then return "✯ 𓏪 ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(bita..'lock:kara:'..msg.chat_id_,'on')
return "✯ 𓏪 ** أهلا عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** تم تعطيل الرفع في المجموعه \n"
end
function cmds_off(msg)
if not msg.Creator then return "✯ 𓏪 ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(bita..'lock:kara:'..msg.chat_id_,'off')
return "✯ 𓏪 ** أهلا عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** تم تفعيل الرفع في المجموعه \n"
end

function lockjoin(msg)
if not msg.Admin then return "✯ 𓏪 *│* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n"
end
redis:set(bita..'lock:join:'..msg.chat_id_,true)
return "*✯ 𓏪 ** أهلا عزيزي *"..msg.TheRankCmd.."*\n✯ 𓏪 ** تم قفل الدخول بالرابط \n*" 
...
bd = '✯ 𓏪 اسمك  ('..(data.first_name_ or '')..')\n✯ 𓏪 معرفك (@'..(data.username_ or '')..')\n\n✯ 𓏪 اشترك بالقناه اولا \n✯ 𓏪 ثم ارجع استخدم الامر.'
local keyboard = {}
...
"✯ 𓏪 ❪ مـعـلومـات الـمـجـموعـه ❫\n\n"
.."*✯ 𓏪 * عدد الأعضاء ⇜ ❪ *"..data.member_count_.."* ❫"
.."\n*✯ 𓏪 * عدد المحظورين ⇜ ❪ *"..data.kicked_count_.."* ❫"
.."\n*✯ 𓏪 * عدد المشرفين ⇜ ❪ *"..data.administrator_count_.."* ❫"
.."\n*✯ 𓏪 * ايدي المجموعه ⇜ ❪"..msg.chat_id_.."❫"
.."\n\n✯ 𓏪 اسم المجموعه ⇜ ❪  ["..FlterName(GroupName).."]("..(data.invite_link_ or "")..")  ❫\n"
)
end,nil) 
return false
end
...
if not msg.Director then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 المعرف غير صحيح \n')   
end   
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 هاذا معرف قناة \n')   
end      
...
return sendMsg(msg.chat_id_,msg.id_,'\n✯ 𓏪 ًاهلا عزيزي البوت هنا ادمن بالقروب \n✯ 𓏪 وصلاحياته هي ↓ \n✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪\n✯ 𓏪 تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n✯ 𓏪 حذف الرسائل ↞ ❪ '..delete..' ❫\n✯ 𓏪 حظر المستخدمين ↞ ❪ '..restrict..' ❫\n✯ 𓏪 دعوة مستخدمين ↞ ❪ '..invite..' ❫\n✯ 𓏪 تثبيت الرسائل ↞ ❪ '..pin..' ❫\n✯ 𓏪 اضافة مشرفين جدد ↞ ❪ '..promote..' ❫\n\n✯ 𓏪 ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 **ً أهلا عزيزي "..msg.TheRankCmd.." \n✯ 𓏪 ** تم تثبيت الرساله \n✓")
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** ًعذرا لا يمكنني التثبيت .\n✯ 𓏪 ** لست مشرف او لا املك صلاحيه التثبيت \n')    
end
end,nil)
end
return false
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 **ًأهلا عزيزي "..msg.TheRankCmd.."  \n✯ 𓏪 ** تم الغاء تثبيت الرساله \n")    
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 **✯ 𓏪 عذراً لا يمكنني الغاء التثبيت .\n✯ 𓏪 ** لست مشرف او لا املك صلاحيه التثبيت \n')    
elseif data.ID == "Error" and data.code_ == 400 then
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** ًعذرا عزيزي '..msg.TheRankCmd..' .\n✯ 𓏪 ** لا توجد رساله مثبته لاقوم بازالتها \n')    
end
end,nil)
end
return false
...
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** أهلا عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** الرفع معطل \n")
end
return false
end
...
if not msg.Creator then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(bita..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(bita..'lock:kara:'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** أهلاً عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** الرفع معطل \n")
end
return false
end
...
if not msg.SudoUser then return "✯ 𓏪 **هذا الامر يخص {المطور,المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "✯ 𓏪 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
if not msg.Kara then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشى الاساسي فقط} فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
return "✯ 𓏪 أهلاً عزيزي "..msg.TheRankCmd.." ↓\n✯ 𓏪 تم تنزيل ❴ "..Admins.." ❵ من الادمنيه\n✯ 𓏪 تم تنزيل ❴ "..NumMDER.." ❵ من المدراء\n✯ 𓏪 تم تنزيل ❴ "..MMEZEN.." ❵ من المميزين\n\n✯ 𓏪 تم تـنـزيـل الـكـل بـنـجـاح\n" 
end
...
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 **تم انشاء رابط جديد \n✯ 𓏪 ["..LinkGp.."]\n✯ 𓏪 لعرض الرابط ارسل { الرابط } \n")
else
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 لا يمكنني انشاء رابط للمجموعه .\n✯ 𓏪 لانني لست مشرف في المجموعه \n")
end
else
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 لقد قمت بانشاء الرابط سابقا .\n✯ 𓏪 ارسل { الرابط } لرؤيه الرابط  \n")
end
return false
end 
...
return '✯ 𓏪 عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(bita..'linkGroup'..msg.chat_id_) then 
return "✯ 𓏪 ** اوه لا يوجد رابط .\n✯ 𓏪 **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
...
if not msg.Admin then return "✯ 𓏪 *│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
local GroupLink = redis:get(bita..'linkGroup'..msg.chat_id_)
if not GroupLink then return "✯ 𓏪 ** اوه لا يوجد هنا رابط\n✯ 𓏪 *رجائا اكتب [ضع رابط]*" end
local Text = "✯ 𓏪 رابـط الـمـجـمـوعه ✯ 𓏪 \n"..Flter_Markdown(redis:get(bita..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if res == 403 then
return "✯ 𓏪 **عذرا عزيزي \n✯ 𓏪 لم استطيع ارسالك الرابط لانك قمت بحظر البوت\n!"
elseif res == 400 then
return "✯ 𓏪 **عذرا عزيزي \n✯ 𓏪 لم استطيع ارسالك الرابط يجب عليك مراسله البوت اولا \n!"
end
if res == 200 then 
return "✯ 𓏪 **أهلاً عزيزي "..msg.TheRankCmd.."  \n✯ 𓏪 تم ارسال الرابط خاص لك ."
end
end
...
return '✯ 𓏪 حسننا عزيزي  .\n✯ 𓏪 الان ارسل القوانين  للمجموعه .'
end

if MsgText[1] == "القوانين" then
if not redis:get(bita..'rulse:msg'..msg.chat_id_) then 
return "✯ 𓏪 **مرحباً عزيري القوانين كلاتي .\n✯ 𓏪 ممنوع نشر الروابط \n✯ 𓏪 ممنوع التكلم او نشر صور اباحيه \n✯ 𓏪 ممنوع  اعاده توجيه\n✯ 𓏪 ممنوع التكلم بالسياسة \n✯ 𓏪 الرجاء احترام المدراء والادمنيه\n"
else 
...
return "✯ 𓏪 ** حدود التكرار ,  يجب ان تكون ما بين  *[2-50]*" 
end
redis:set(bita..'flood'..msg.chat_id_,MsgText[2]) 
return "✯ 𓏪 ** تم وضع التكرار » { *"..MsgText[2].."* }"
end
...
if MsgText[2] and MsgText[2]:match('^%d+$') then
if not msg.Director then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if 500 < tonumber(MsgText[2]) then return "✯ 𓏪 ** حدود المسح ,  يجب ان تكون ما بين  *[2-100]*" end
...
sendMsg(msg.chat_id_,msg.id_,"*✯ 𓏪 * تـم مسح ←  { *"..MsgText[2].."* } من الرسائل  \n")
end,nil))
else
pcall(tdcli_function({ID="DeleteMessages",chat_id_=msg.chat_id_,message_ids_=All_Msgs},function() 
sendMsg(msg.chat_id_,msg.id_,"*✯ 𓏪 * تـم مسح ←  { *"..MsgText[2].."* } من الرسائل  \n")
...
local Admins = redis:scard(bita..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "✯ 𓏪 ** اوه هنالك خطأ .\n✯ 𓏪 عذراً لا يوجد ادمنيه ليتم مسحهم ." 
end
redis:del(bita..'admins:'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم مسح {"..Admins.."} من الادمنيه في البوت \n"
end
...
if Mn3Word == 0 then 
return "✯ 𓏪 ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(bita..':Filter_Word:'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم مسح {*"..Mn3Word.."*} كلمات من المنع"
end
...
if not msg.Director then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(bita..'rulse:msg'..msg.chat_id_) then 
return "✯ 𓏪 عذراً لا يوجد قوانين ليتم مسحه \n!" 
end
redis:del(bita..'rulse:msg'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم حذف القوانين بنجاح"
end
...
return "✯ 𓏪 ** اوه هنالك خطأ .\n✯ 𓏪 عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(bita..'welcome:msg'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم حذف الترحيب بنجاح \n"
end
...
if not msg.Creator then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local NumMDER = redis:scard(bita..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "✯ 𓏪 عذراً لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(bita..'owners:'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم مسح {* "..NumMDER.." *} من المدراء  \n"
end
...
if #list == 0 then return "*✯ 𓏪 لا يوجد مستخدمين محظورين  *" end
message = '✯ 𓏪 ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(bita..'banned:'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪  تم مسح {* "..#list.." *} من المحظورين  \n"
end
...
if MKTOMEN ==0 then 
return "✯ 𓏪 ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(bita..'is_silent_users:'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم مسح {* "..MKTOMEN.." *} من المكتومين  \n"
end
...
local MMEZEN = redis:scard(bita..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*✯ 𓏪 *لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(bita..'whitelist:'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم مسح {* "..MMEZEN.." *} من المميزين  \n"
end
...
if not msg.Director then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(bita..'linkGroup'..msg.chat_id_) then
return "*✯ 𓏪 *لا يوجد رابط مضاف اصلا " 
end
redis:del(bita..'linkGroup'..msg.chat_id_)
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."   \n✯ 𓏪 تم مسح رابط المجموعه \n"
end
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم مسح الصوره المجموعه .\n')
end
...
function(arg,data)
if data.ID == "Ok" then
--return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم تغيير صوره المجموعه ⠀\n')
elseif  data.code_ == 3 then
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ليس لدي صلاحيه تغيير الصوره \n✯ 𓏪 يجب اعطائي صلاحيه `تغيير معلومات المجموعه ` ⠀\n')
end
end, nil)
end
...
return "✯ 𓏪 حسننا عزيزي .\n✯ 𓏪 الان ارسل الوصف  للمجموعه\n" 
end


if MsgText[1] == "طرد البوتات" then
if not msg.Director then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
tdcli_function({ID="GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''),
filter_ ={ID="ChannelMembersBots"},offset_ = 0,limit_ = 50},function(arg,data)
local Total = data.total_count_ or 0
if Total == 1 then
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 لا يـوجـد بـوتـات في الـمـجـمـوعـه .") 
else
local NumBot = 0
local NumBotAdmin = 0
...
local TextR  = "✯ 𓏪 عـدد الـبـوتات ✯ 𓏪⊱ {* "..(Total - 1).." *} ⊰✯ 𓏪\n\n"
if NumBot == 0 then 
TextR = TextR.."✯ 𓏪 لا يـمـكـن طردهم لانـهـم مشـرفـين .\n"
else
if NumBotAdmin >= 1 then
TextR = TextR.."✯ 𓏪 لم يتم طـرد {* "..NumBotAdmin.." *} بوت لأنهم مـشـرفين."
else
TextR = TextR.."✯ 𓏪 تم طـرد كــل البوتات بنجاح .\n"
end
end
...
filter_ ={ID= "ChannelMembersBots"},offset_ = 0,limit_ = 50},function(arg,data)
local total = data.total_count_ or 0
AllBots = '✯ 𓏪 قـائمه البوتات الـحالية\n\n'
local NumBot = 0
for k, v in pairs(data.members_) do
...
✯ 𓏪 لديك {]]..total..[[} بوتات
✯ 𓏪 ملاحظة : الـ ♚ تعنـي ان البوت مشرف في المجموعـة.]]
...
if not msg.Creator then return "✯ 𓏪 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 جارٍ البحث عن الحسابات المحذوفة ...')
tdcli_function({ID="GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100','')
...
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 تم طـرد {* "..NumMemDone.." *} من الحسابات المحذوفه‏‏ .")
else
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 لا يوجد حسابات محذوفه في المجموعه .')
end
end
end,nil)
end
...
local Get_info =  " \n✯ 𓏪 ( الاحـصـائـيـات الـرسـائـلك )\n \n"
.."✯ 𓏪 الـرسـائـل ( "..msgs.." )\n"
.."✯ 𓏪 الـجـهـات ( "..NumGha.." )\n"
.."✯ 𓏪 الـصـور ( "..photo.." )\n"
.."✯ 𓏪 الـمـتـحـركـه ( "..animation.." )\n"
.."✯ 𓏪 الـمـلـصـقات ( "..sticker.." )\n"
.."✯ 𓏪 الـبـصـمـات ( "..voice.." )\n"
.."✯ 𓏪 الـصـوت ( "..audio.." )\n"
.."✯ 𓏪 الـفـيـديـو ( "..video.." )\n"
.."✯ 𓏪 الـتـعـديـل ( "..edited.." )\n"
...
local msgs = redis:get(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if rfih == 0 then  return "✯ 𓏪 **عذرا لا يوجد رسائل لك في البوت  ." end
redis:del(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "✯ 𓏪 **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '✯ 𓏪 **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "✯ 𓏪 **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
return "✯ 𓏪 **تم مسح {* "..adduser.." *} من جهاتك\n✓"
end
...
if points == 0 then  return "✯ 𓏪 **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
return "✯ 𓏪 **تم مسح {* "..points.." *} من نقاطك\n"
end
...
local Get_info ="✯ 𓏪 اهلاً بك في معلوماتك . \n"
.."𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓\n"
.."✯ 𓏪 الأسم ( "..FlterName(data.first_name_..' '..(data.last_name_ or ""),25).." )\n"
.."✯ 𓏪 المعرف ( "..ResolveUser(data).." )\n"
.."✯ 𓏪 الأيدي ( `"..msg.sender_user_id_.."` )\n"
.."✯ 𓏪 رتبتك ( "..msg.TheRank.." )\n"
.."✯ 𓏪 ـ ( `"..msg.chat_id_.."` )\n"
.."𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓\n"
.." ✯ 𓏪 الأحصائيات الرسائل .\n"
.."✯ 𓏪 الرسائل ( `"..msgs.."` )\n"
.."✯ 𓏪 الجهات ( `"..NumGha.."` )\n"
.."✯ 𓏪 الصور ( `"..photo.."` )\n"
.."✯ 𓏪 المتحركه ( `"..animation.."` )\n"
.."✯ 𓏪 الملصقات ( `"..sticker.."` )\n"
.."✯ 𓏪 البصمات ( `"..voice.."` )\n"
.."✯ 𓏪 الصوت ( `"..audio.."` )\n"
.."✯ 𓏪 الفيديو ( `"..video.."` )\n"
...
local Get_info ="✯ 𓏪 أهلاً عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
return "✯ 𓏪 حسننا عزيزي .\n✯ 𓏪 ارسل كليشه الترحيب الان\n\n✯ 𓏪 ملاحظه تستطيع اضافه دوال للترحيب مثلا :\n✯ 𓏪 أظهار قوانين المجموعه  » *{القوانين}*  \n✯ 𓏪  أظهار الاسم العضو » *{الاسم}*\n✯ 𓏪 أظهار المعرف العضو » *{المعرف}*\n✯ 𓏪 أظهار اسم المجموعه » *{المجموعه}*" 
end
...
if not msg.SudoBase then return"✯ 𓏪 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local mtwren = redis:scard(bita..':SUDO_BOT:')
if mtwren == 0 then  return "✯ 𓏪 ** عذراً لا يوجد مطورين في البوت ." end
redis:del(bita..':SUDO_BOT:') 
return "✯ 𓏪 ** تم مسح {* "..mtwren.." *} من المطورين .\n"
end
...
if addbannds ==0 then 
return "*✯ 𓏪 قائمة الحظر فارغه .*" 
end
redis:del(bita..'gban_users') 
return "✯ 𓏪 ** تـم مـسـح { *"..addbannds.." *} من قائمه العام\n" 
end 
...
if GroupDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** جـيـد , لا توجد مجموعات وهميه \n')
else
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** عدد المجموعات ✯ 𓏪⊱ { *'..#groups..'*  } ⊰✯ 𓏪\n✯ 𓏪 ** تـم تنظيف  ✯ 𓏪⊱ { *'..GroupDel..'*  } ⊰✯ 𓏪 مجموعه \n✯ 𓏪 ** اصبح العدد الحقيقي الان ✯ 𓏪⊱ { *'..GroupsIsFound..'*  } ⊰✯ 𓏪 مجموعه')
end
end
end)
end
...
if #pv == i then 
if NumPvDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 جـيـد , لا يوجد مشتركين وهمي')
else
local SenderOk = #pv - NumPvDel
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** عدد المشتركين ✯ 𓏪⊱ { *'..#pv..'*  } ⊰✯ 𓏪\n✯ 𓏪 ** تـم تنظيف  ✯ 𓏪⊱ { *'..NumPvDel..'*  } ⊰✯ 𓏪 مشترك \n✯ 𓏪 ** اصبح العدد الحقيقي الان ✯ 𓏪⊱ { *'..SenderOk..'*  } ⊰✯ 𓏪 من المشتركين') 
end
end
end)
end)
...
return'✯ 𓏪 حسننا عزيزي .\n✯ 𓏪 الان قم بارسال الصوره للترحيب \n' 
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[✯ 𓏪 اهلا انا بوت]]..redis:get(bita..':NameBot:')..[[ .
✯ 𓏪 اختصاصي حماية‌‏ المجموعات
✯ 𓏪 مـن السبام والتوجيه‌‏ والتكرار والخ...

✯ 𓏪 مـعـرف الـمـطـور  » ]]..SUDO_USER:gsub([[\_]],'_')..[[ .
]])

return false
else
return "✯ 𓏪 لا توجد صوره مضافه للترحيب في البوت \n✯ 𓏪 لاضافه صوره الترحيب ارسل `ضع صوره للترحيب`"
end
end

if MsgText[1] == "ضع كليشه المطور" then 
redis:setex(bita..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '✯ 𓏪 حسننا عزيزي .\n✯ 𓏪 الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(bita..':addnumberusers',MsgText[2]) 
return '✯ 𓏪 ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'✯ 𓏪 ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(bita..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "✯ 𓏪 **هذا الامر يخص {المطور} فقط  \n" end
return '✯ 𓏪 ** عدد المجموعات المفعلة » `'..redis:scard(bita..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "✯ 𓏪 **هذا الامر يخص {المطور} فقط  \n" end
return '✯ 𓏪 **عدد المشتركين في البوت : `'..redis:scard(bita..'users')..'` \n'
end

if MsgText[1] == 'قائمه المجموعات' then 
if not msg.SudoBase then return "✯ 𓏪 **هذا الامر يخص {المطور} فقط  \n" end
...
sendMsg(MsgText[2],0,'✯ 𓏪 ** تم تعطيل المجموعه بأمر من المطور  \n✯ 𓏪 ** سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '✯ 𓏪 ** تم تعطيل المجموعه ومغادرتها \n✯ 𓏪 ** المجموعة » ['..name_gp..']\n✯ 𓏪 ** الايدي » ( *'..MsgText[2]..'* )\n'
else 
return '✯ 𓏪 ** لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 

if MsgText[1] == 'المطور' then
return redis:get(bita..":TEXT_SUDO") or '✯ 𓏪 لا توجد كليشه المطور .\n✯ 𓏪 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end
...
return "✯ 𓏪 ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(bita..'fwd:'..msg.sender_user_id_,300, true) 
return "✯ 𓏪 حسننا الان ارسل التوجيه للاذاعه \n" 
end
...
return "✯ 𓏪 حسننا الان ارسل الكليشه للاذاعه عام \n" 
end
...
return "✯ 𓏪 حسننا الان ارسل الكليشه للاذاعه خاص \n"
end
...
return "✯ 𓏪 حسننا الان ارسل الكليشه للاذاعه للمجموعات \n" 
end
...
return "✯ 𓏪 **هذا الامر يخص {المطور الاساسي} فقط  \n" 
end
...
if MsgText[1] == "رتبتي" then return '✯ 𓏪 ** رتبتك ←  ( '..msg.TheRank..' )\n' end
...
return '✯ 𓏪 اصدار سورس بيتٲ : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس بيتٲ يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
return "✯ 𓏪 ** ارسل ملف النسخه الاحتياطيه اولا\n✯ 𓏪 ** ثم قم بالرد على الملف وارسل \" `رفع نسخه الاحتياطيه` \" "
end 
return false
end
...
if not msg.SudoBase then return"✯ 𓏪 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return "✯ 𓏪 البوت شـغــال ." 
end

if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي🆔") and msg.type == "pv" then return  "\n✯ 𓏪 اهلاً عزيزي المطور ايديك :\n\n✯ 𓏪 "..msg.sender_user_id_.."\n"  end
...
if not msg.SudoBase then return"✯ 𓏪 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '✯ 𓏪 الاحصائيات . \n\n✯ 𓏪 **عدد المجموعات المفعله : '..redis:scard(bita..'group:ids')..'\n✯ 𓏪 **عدد المشتركين في البوت : '..redis:scard(bita..'users')..'\n'
end
---------------[End Function data] -----------------------
...
return "✯ 𓏪 حسننا الان ارسل كلمة الرد العام .\n"
end
...
return "✯ 𓏪 تم مسح كل الردود ."
else
return '✯ 𓏪 ** لا يوجد ردود ليتم مسحها \n'
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود العامه' then
if not msg.SudoBase then return"✯ 𓏪 للمطورين فقط ." end
...
return "✯ 𓏪 تم مسح كل الردود العامه ."
else
return "✯ 𓏪 لا يوجد ردود عامه ليتم مسحها ."
end
end
...
return '✯ 𓏪 **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '✯ 𓏪 **ردود البوت في المجموعه  :\n\n'
...
if not msg.SudoBase then return "✯ 𓏪 للمطور فقط ." end
...
local ii = 1
local message = '✯ 𓏪 **الردود العامه في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *}_*( صوره ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *}_*( نص ) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *}_*( بصمه ) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *}_*( متحركه ) \n'ii = ii + 1 end
...
↤︎ ‌‌‏الاوامر ↓
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
✯ 𓏪 م1 ↤︎ اوامر الاداره‌‏
✯ 𓏪 م2 ↤︎ اوامر اعدادات المجموعه‌‏
✯ 𓏪 م3 ↤︎ اوامر الحماية‌‏
✯ 𓏪 م4 ↤︎ اوامر الخدمه 
✯ 𓏪 م5 ↤︎ اوامر التسليه
✯ 𓏪 م6 ↤︎ اوامر التعطيل و التفعل
✯ 𓏪 م7 ↤︎ اوامر الوضع للمجموعه
✯ 𓏪 م المطور ↤︎  اوامر المطور
✯ 𓏪 اوامر الرد ↤︎ الاظافة‌‏ رد معين
✯ 𓏪 الوسائط ↤︎ لمعرفه الاعدادات 
✯ 𓏪 الاعدادات ↤︎ عدادات المجموعه
✯ 𓏪 سورس ↤︎ سورس البوت
✯ 𓏪 المطور ↤︎ مطور البوت
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
 ‏‎‏✯ 𓏪 معـرف المـطور ↤︎{ ]]..SUDO_USER..[[ } ✓ ]]
end
...
❬اوامر المسح❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
✯ 𓏪 مسح الادمنـيـه › ❬لمسح الادمنيه❭
✯ 𓏪 مسح المميزين › ❬لمسح المميزين❭
✯ 𓏪 مسح المــــدراء › ❬لمسح المدراء❭
✯ 𓏪 مسح المنشئيين › ❬لمسح المنشئيين❭
✯ 𓏪 مسح الاساسيين › ❬لمسح المنشئيين الاساسيين❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
❬اوامر الحظر والطرد والتقييد❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
✯ 𓏪 حظر ❬بالرد › بالمعرف❭ لحظر العضو
✯ 𓏪 الغاء الحظر ❬بالرد › بالمعرف❭ لالغاء الحظر 
✯ 𓏪 طرد ❬بالرد › بالمعرف❭ لطرد العضو
✯ 𓏪 كتم ❬بالرد › بالمعرف❭ لكتم العضو 
✯ 𓏪 الغاء الكتم ❬بالرد›بالمعرف❭لالغاء الكتم 
✯ 𓏪 تقييد ❬بالرد › بالمعرف❭ لتقييد العضو
✯ 𓏪 فك التقييد ❬بالرد › بالمعرف❭ لالغاء تقييد العضو
✯ 𓏪 منع + الكلمه › لمنع كلمه داخل المجموعه
✯ 𓏪 الغاء منع › لالغاء منع الكلمه
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
✯ 𓏪 ** معـرف المـطور↤︎ ]]..SUDO_USER
...
❬اوامر الاعدادات❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
✯ 𓏪
** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(bita..'lave_me'..msg.chat_id_,true)  
return "✯ 𓏪 **أهلا عزيزي "..msg.TheRankCmd.."\n✯ 𓏪 ** تم تعطيل المغادره من قبل البوت\n✓" 
end   
end

if MsgText[1] == "اطردني" or MsgText[1] == "احظرني" then
if not redis:get(bita..'lave_me'..msg.chat_id_) then
if msg.Admin then return "✯ 𓏪 **لا استطيع طرد المدراء والادمنيه والمنشئين  \n✯ 𓏪 " end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"✯ 𓏪 أهلاً عزيزي , لقد تم طردك من المجموعه بامر منك \n✯ 𓏪 اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n✯ 𓏪 فهذا رابط المجموعه\n✯ 𓏪 "..Flter_Markdown(redis:get(bita..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(bita..'linkGroup'..msg.chat_id_).."]\n")
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 لقد تم طردك بنجاح , ارسلت لك رابط المجموعه في الخاص اذا وصلت لك تستطيع الرجوع متى شئت ")
else
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪  لا استطيع طردك لانك مشرف في المجموعه  ")
end
end)
return false
end
...
return [[
✯ 𓏪 [ 𝙱𝙸𝚃𝙰 𝙲𝙷𝙰𝙽𝙴𝙻 ⁦](t.me/baselabaza)

✯ 𓏪 [𝙳𝙴𝚅](t.me/xb_0b)

✯ 𓏪 [ 𝚃𝚆𝙰𝚂𝙾𝙻 💬](t.me/abazaxbot)
...
return "\n✯ 𓏪  الـتـاريـخ : "..os.date("%Y/%m/%d")
end

if MsgText[1]== "سحكاتي" then
return '✯ 𓏪 **عدد سحكاتك ⇜ ❪ '..(redis:get(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "✯ 𓏪 *│* لا يوجد سحكات لك في البوت ." end
redis:del(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
return "✯ 𓏪 *│*تم مسح {* "..rfih.." *} من سحكاتك .\n"
end

if MsgText[1] == "تفعيل الاشتراك الاجباري" or MsgText[1] == "تفعيل الاشتراك الاجباري ☑" then
if not msg.SudoBase then return"✯ 𓏪 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(bita..":UserNameChaneel") then
return "✯ 𓏪 اهلا عزيزي المطور \n✯ 𓏪 الاشتراك بالتأكيد مفعل"
else
redis:setex(bita..":ForceSub:"..msg.sender_user_id_,350,true)
return "✯ 𓏪 مرحبا بـك في نظام الاشتراك الاجباري\n✯ 𓏪 الان ارسل معرف قـنـاتـك"
end
if Text == "الغاء" then 
...
if SubDel == 1 then
return "✯ 𓏪 تم تعطيل الاشتراك الاجباري . \n✓"
else
return "✯ 𓏪 الاشتراك الاجباري بالفعل معطل . \n✓"
end
end
...
if UserChaneel then
return "✯ 𓏪 اهلا عزيزي المطور \n✯ 𓏪 الاشتراك الاجباري للقناة : ["..UserChaneel.."]\n"
else
return "✯ 𓏪 لا يوجد قناة مفعله على الاشتراك الاجباري . \n"
end
end
...
txt = '✯ 𓏪 اهلآ عزيزي '..(Diamond.first_name_ or '---')..'\n✯ 𓏪 المجموعه  '..(data.title_ or '---')..' \n✯ 𓏪 احترام الادمنيه\n✯ 𓏪 ممنوع طلب الرتب\n✯ 𓏪 ممنوع السب \n✯ 𓏪 ممنوع التكلم بالسياسة\n✯ 𓏪 الاعضاء '..mrr619.member_count_..' عضو\n✯ 𓏪 الادمنيه '..mrr619.administrator_count_..' \n✯ 𓏪 وقت الانضمام :【*'..os.date("%H:%M:%S")..'*】\n✯ 𓏪 تاريخ الانضمام :【*'..os.date("%Y/%m/%d")..'*】\n'
...
if not msg.Kara then return "✯ 𓏪 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(black,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 الأسم : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n✯ 𓏪 تم رفعه مشرف بكامل الصلاحيات\n‌‏')
...
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 اهلا عزيزي \n✯ 𓏪 تم تثبيت الامر الجديد\n✓')
...
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 اهلا بك عزيزي\n✯ 𓏪 الامر الي تريد تغيره الي  "'..cmd..'" \n✯ 𓏪 ارسله الان\n')
end
...
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 عزيزي المستخدم\n✯ 𓏪 الامر فقط للصوره\n')
end
end
...
return sendMsg(msg.chat_id_,0,'*✯ 𓏪 * تم حظرك من البوت بسبب التكرار \n') 
end
...
text = [[✯ 𓏪 أهلاً انا بوت   []]..redis:get(bita..':NameBot:')..[[] 
✯ 𓏪 اختـصاصـي حمايـة الـمجموعات
✯ 𓏪من التكـرار والسـبام وبوتـات التفـليش ومـن الشـير الايرانـي والخ
✯ 𓏪فقط اضف للبوت لمجموعتك وارفعه مشرف واكتب تفعيل ▧
[قنـاة سورس بيتآ ᪤](t.me/baselabaza)

✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪
 ✯ 𓏪 مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
else
text = [[✯ 𓏪 أهلاً انا بوت    []]..redis:get(bita..':NameBot:')..[[] 
✯ 𓏪 اختـصاصـي حمايـة الـمجموعات
...
SendMention(msg.sender_user_id_,data.id_,msg.id_,"✯ 𓏪 تم ارسال الرسالة .\n✯ 𓏪 إلى : "..USERNAME.." .",39,USERCAR) 
return false 
end,nil)
end  
end,nil)
...
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 عذراً لا يمكنك ارسال { توجيه‌‏ , ملصق , فديو كام} .")
return false
end
redis:setex(bita.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 تم آرسـآل رسالتك إلى المطور\n✯ 𓏪 سـآرد عليك في اقرب وقت ممكن \n✯ 𓏪 معرف المطور "..SUDO_USER)
...
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه صوره للرد بنجاح\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(bita..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه بصمه صوت للرد بنجاح\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(bita..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه متحركه للرد بنجاح\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(bita..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه فيديو للرد بنجاح\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(bita..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه للصوت للرد بنجاح\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(bita..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه ملصق للرد بنجاح\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الملصق الاتي ')
end  
...
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✯ 𓏪 تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(bita..'replay_photo:group:',klma,photo_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه صوره للرد العام\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(bita..'replay_voice:group:',klma,voice_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه بصمه صوت للرد العام\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(bita..'replay_animation:group:',klma,animation_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه متحركه للرد العام\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(bita..'replay_video:group:',klma,video_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه فيديو للرد العام\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(bita..'replay_audio:group:',klma,audio_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه للصوت للرد العام\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(bita..'replay_sticker:group:',klma,sticker_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم اضافه ملصق للرد العام\n✯ 𓏪 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الملصق الاتي ')
end  
...
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 عذراً , هناك خطأ لديك \n✯ 𓏪 المعرف الذي ارسلته ليس معرف قناة.")
return false
elseif Req.description == "Bad Request: CHAT_ADMIN_REQUIRED" then
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 عذراً , لقد نسيت شيئا \n✯ 𓏪 يجب رفع البوت مشرف في قناتك لتتمكن من تفعيل الاشتراك الاجباري .")
return false
end
else
redis:set(bita..":UserNameChaneel",msg.text)
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 جـيـد , الان لقد تم تفعيل الاشتراك الاجباري\n✯ 𓏪 على قناتك ⇜ ["..msg.text.."]")
return false
end
else
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 عذرا , عزيزي المطور \n✯ 𓏪 هذا ليس معرف قناة , حاول مجددا .")
return false
end
end
...
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 تم تغير اسم البوت  .\n✯ 𓏪 الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end
...
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 جيد , يمكنك الان ارسال جوا ب الردالعام \n✯ 𓏪 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 **هذا الرد ليس مضاف في قائمه الردود .')
else
...
return sendMsg(msg.chat_id_,msg.id_, "✯ 𓏪 ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
...
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 ** مرحبآ عزيزي\n✯ 𓏪 تم حفظ القوانين بنجاح .\n✯ 𓏪 ارسل [[ القوانين ]] لعرضها \n')
end
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم وضع الرابط الجديد بنجاح .. 🍂')
end
...
if data.ID == "Ok" then 
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** تم وضع الوصف بنجاح\n")
end 
end,nil)
end
...
if allgp >= 300 then
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 اهلا عزيزي المطور \n✯ 𓏪 جاري نشر التوجيه للمجموعات وللمشتركين ...')			
end
for i = 1, #pv do 
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 **تم اذاعه الكليشه بنجاح .\n✯ 𓏪 **للمجموعات » ( *'..#groups..'* )\n✯ 𓏪 ** للمشتركين » ( '..#pv..' )\n')
end
...
if #pv == i then 
local SenderOk = #pv - NumPvDel
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 **عدد المشتركين : ❴ '..#pv..' ❵\n✯ 𓏪 **تم الاذاعه الى ❴ '..SenderOk..'  ❵ مشترك \n') 
end
end)
end
end
...
sendMsg(msg.chat_id_,msg.id_,'*¦* عدد المجموعات ✯ 𓏪⊱ { *'..#groups..'*  } ⊰✯ 𓏪\n*¦* تـم الاذاعه بالتثبيت بنجاح ')
end 
...
MsgTDel = '✯ 𓏪 **تم حذف ❴ *'..NumGroupsDel..'* ❵ من قائمه الاذاعه لانهم قامو بطرد البوت من المجموعه'
else
MsgTDel = ''
end
sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 **عدد المجموعات ❴ *'..#groups..'* ❵\n✯ 𓏪 **تـم الاذاعه الى ❴ *'..AllGroupSend..'* ❵\n'..MsgTDel..'')
end
end)
end
end 
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(bita..':WELCOME_BOT'),[[✯ 𓏪أهلاً انا بوت ]]..redis:get(bita..':NameBot:')..[[
✯ 𓏪 أختصاصي حماية‌‏ المجموعات
✯ 𓏪 مـن السبام والتوجيه‌‏ والتكرار والخ...
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 **تم اذاعه التوجيه بنجاح .\n✯ 𓏪 **للمجموعات » ❴ *'..#groups..'* ❵\n✯ ?? **للخاص » ❴ '..#pv..' ❵\n')			
end
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 
...
sendMsg(arg.chat_id_,arg.id_,'✯ 𓏪 ليس لدي صلاحيه تغيير الصوره \n✯ 𓏪 يجب اعطائي صلاحيه `تغيير معلومات المجموعه ` ⠀\n')
end
...
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 جيد , يمكنك الان ارسال جواب الرد \n✯ 𓏪 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end
...
function(arg,data)
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** ًعذرا التثبيت مقفل من قبل الاداره تم ارجاع التثبيت القديم\n")
end
end,nil)
else
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 ** ًعذرا التثبيت مقفل من قبل الاداره تم الغاء التثبيت\n")      
end
end,nil)
end
return false
...
return sendMsg(msg.chat_id_,msg.id_,"✯ 𓏪 قام  ["..UserName.."]\n✯ 𓏪 بتغير اسم المجموعه .\n✯ 𓏪 الى "..Flter_Markdown(msg.content_.title_).." \n") 
end)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(bita..'welcome:msg'..msg.chat_id_) or "✯ 𓏪 اهلاً عزيزي {الاسم}\n✯ 𓏪 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\n✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪\n✯ 𓏪 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(bita..'rulse:msg'..msg.chat_id_) or "✯ 𓏪 مرحباً عزيري القوانين كلاتي .\n✯ 𓏪 ممنوع نشر الروابط\n✯ 𓏪 ممنوع التكلم او نشر صور اباحيه\n✯ 𓏪 ممنوع  اعاده توجيه\n✯ 𓏪 ممنوع التكلم بالسياسة\n✯ 𓏪 الرجاء احترام المدراء والادمنيه .\n")
...
welcome = (redis:get(bita..'welcome:msg'..msg.chat_id_) or "✯ 𓏪 اهلن بك عزيزي {الاسم}\n✯ 𓏪 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\n✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪\n✯ 𓏪 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(bita..'rulse:msg'..msg.chat_id_) or "✯ 𓏪 مرحباً عزيري القوانين كلاتي .\n✯ 𓏪 ممنوع نشر الروابط\n✯ 𓏪 ممنوع التكلم او نشر صور اباحيه\n✯ 𓏪 ممنوع  اعاده توجيه\n✯ 𓏪 ممنوع التكلم بالسياسة\n✯ 𓏪 الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"✯ 𓏪 العضو » "..USERNAME.."\n✯ 𓏪 قمـت بتكرار اكثر مـن "..NUM_MSG_bita.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 صلاحياته منشئ القروب\n')   
end 
if Json_Info.result.status == "member" then
return sendMsg(msg.chat_id_,msg.id_,'✯ 𓏪 مجرد عضو هنا\n')   
end 
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
info = 'ꪜ' else info = '✘' end
...
if Json_Info.result.can_promote_members == true then
promote = 'ꪜ' else promote = '✘' end
return sendMsg(chat,msg.id_,'✯ 𓏪 الرتبة : مشرف\n✯ 𓏪 والصلاحيات هي ↓ \n✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪\n✯ 𓏪 تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n✯ 𓏪 حذف الرسائل ↞ ❪ '..delete..' ❫\n✯ 𓏪 حظر المستخدمين ↞ ❪ '..restrict..' ❫\n✯ 𓏪 دعوة مستخدمين ↞ ❪ '..invite..' ❫\n✯ 𓏪 تثبيت الرسائل ↞ ❪ '..pin..' ❫\n✯ 𓏪 اضافة مشرفين جدد ↞ ❪ '..promote..' ❫\n\n✯ 𓏪 ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "✯ 𓏪 ع
�� 𓍼 𓍽 𓍾 𓍿 𓎀 𓎁 𓎂 𓎃 𓎄 𓎅 𓎆 𓎇 𓎈 𓎉 𓎊 𓎋 𓎌 𓎍 𓎎 𓎏 𓎐 𓎑 𓎒 𓎓 𓎔 𓎕 𓎖 𓎗 𓎘 𓎙 𓎚 𓎛 𓎜 𓎝 𓎞 𓎟 𓎠 𓎡 𓏋 𓏌 𓏍 𓏎 𓏏 𓏐 𓏑 𓏒 𓏓 𓏕 𓏖 𓏗 𓏘 𓏙 𓏚 𓏛 𓏜 𓏝 𓏞 𓏟 𓏠 𓏡 𓏢 𓏣 𓏤 𓏥 𓏦 𓏧 𓏨 𓏩 𓏪 𓏫 𓏬 𓏭 𓏮 𓏯 𓏰 𓏱 𓏲 𓏳 𓏴 𓏶 𓏷 ✯ 𓏪 𓏹 𓏺 𓏻 \n☆")
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪\n✯ 𓏪 مرحباً عزيزي\n✯ 𓏪 هذي اوامر التسليه:  \n✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪\n✯ 𓏪 رفع › تنزيل ❬ متوحد ❭\n✯ 𓏪 رفع › تنزيل ❬ وتكه ❭\n✯ 𓏪 رفع › تنزيل ❬ غبي ❭\n✯ 𓏪 رفع › تنزيل ❬ كلب ❭\n✯ 𓏪 رفع › تنزيل ❬ حمار ❭\n✯ 𓏪 رفع › تنزيل ❬ زوجتي ❭\n✯ 𓏪 رفع › تنزيل ❬ متوحده ❭\n✯ 𓏪 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\n✯ 𓏪 ❬ طلاق ❭ › ❬ زواج ❭\n✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪✯ 𓏪")
  ...
  return sendMsg(msg.chat_id_,msg.id_,[[
  ✯ 𓏪 رابط حذف حساب التليجرام
✯ 𓏪 [أضغط هُنا](https://telegram.org/deactivate) - .
‏
  ]] )
  --=====================================
...
if not redis:get('kar') then
  ...
  Save_Data:close()
  sendDocument(SUDO_ID,0,"./inc/"..Bot_User..".json","✯ 𓏪 ملف نسخه تلقائيه\n✯ 𓏪   اليك مجموعاتك » { "..#All_Groups_ID.." }\n✯ 𓏪 للبوت » "..Bot_User.."\n✯ 𓏪 التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
  end
  if redis:get(bita..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(bita..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'✯ 𓏪 انتهى الاشتراك في احد المجموعات .\n✯ 𓏪 المجموعه : '..FlterName(redis:get(bita..'group:name'..msg.chat_id_))..'.\n✯ 𓏪 ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'✯ 𓏪 انتهى الاشتراك البوت.\n✯ 𓏪 سوف اغادر المجموعه فرصه سعيده .\n✯ 𓏪 او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(bita..'ExpireDate:'..msg.chat_id_) / 86400)
  if tonumber(DaysEx) > 0.208 and ExpireDate ~= -1 and msg.Admin then
  if tonumber(DaysEx + 1) == 1 and not msg.SudoUser then
  sendMsg(msg.chat_id_,'✯ 𓏪 باقي يوم واحد وينتهي الاشتراك .\n✯ 𓏪 راسل المطور للتجديد '..SUDO_USER..'\n')
  end 
  end 
  end
  end

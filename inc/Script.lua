...
return "𓏸 𓇡 *│* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n"
end
redis:set(bita.."getidstatus"..msg.chat_id_, "Simple")
return  "𓏸 𓇡 ** أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** تم تعطيل الايدي بالصوره  \n" 
end 
...
return  "𓏸 𓇡 ** أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** تم تفعيل الايدي بالصوره \n" 
end
function cmds_on(msg)
if not msg.Creator then return "𓏸 𓇡 ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(bita..'lock:kara:'..msg.chat_id_,'on')
return "𓏸 𓇡 ** أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** تم تعطيل الرفع في المجموعه \n"
end
function cmds_off(msg)
if not msg.Creator then return "𓏸 𓇡 ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(bita..'lock:kara:'..msg.chat_id_,'off')
return "𓏸 𓇡 ** أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** تم تفعيل الرفع في المجموعه \n"
end

function lockjoin(msg)
if not msg.Admin then return "𓏸 𓇡 *│* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n"
end
redis:set(bita..'lock:join:'..msg.chat_id_,true)
return "*𓏸 𓇡 ** أهلا عزيزي *"..msg.TheRankCmd.."*\n𓏸 𓇡 ** تم قفل الدخول بالرابط \n*" 
...
bd = '𓏸 𓇡 اسمك  ('..(data.first_name_ or '')..')\n𓏸 𓇡 معرفك (@'..(data.username_ or '')..')\n\n𓏸 𓇡 اشترك بالقناه اولا \n𓏸 𓇡 ثم ارجع استخدم الامر.'
local keyboard = {}
...
"𓏸 𓇡 ❪ مـعـلومـات الـمـجـموعـه ❫\n\n"
.."*𓏸 𓇡 * عدد الأعضاء ⇜ ❪ *"..data.member_count_.."* ❫"
.."\n*𓏸 𓇡 * عدد المحظورين ⇜ ❪ *"..data.kicked_count_.."* ❫"
.."\n*𓏸 𓇡 * عدد المشرفين ⇜ ❪ *"..data.administrator_count_.."* ❫"
.."\n*𓏸 𓇡 * ايدي المجموعه ⇜ ❪"..msg.chat_id_.."❫"
.."\n\n𓏸 𓇡 اسم المجموعه ⇜ ❪  ["..FlterName(GroupName).."]("..(data.invite_link_ or "")..")  ❫\n"
)
end,nil) 
return false
end
...
if not msg.Director then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 المعرف غير صحيح \n')   
end   
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 هاذا معرف قناة \n')   
end      
...
return sendMsg(msg.chat_id_,msg.id_,'\n𓏸 𓇡 ًاهلا عزيزي البوت هنا ادمن بالقروب \n𓏸 𓇡 وصلاحياته هي ↓ \n𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡\n𓏸 𓇡 تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n𓏸 𓇡 حذف الرسائل ↞ ❪ '..delete..' ❫\n𓏸 𓇡 حظر المستخدمين ↞ ❪ '..restrict..' ❫\n𓏸 𓇡 دعوة مستخدمين ↞ ❪ '..invite..' ❫\n𓏸 𓇡 تثبيت الرسائل ↞ ❪ '..pin..' ❫\n𓏸 𓇡 اضافة مشرفين جدد ↞ ❪ '..promote..' ❫\n\n𓏸 𓇡 ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 **ً أهلا عزيزي "..msg.TheRankCmd.." \n𓏸 𓇡 ** تم تثبيت الرساله \n✓")
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** ًعذرا لا يمكنني التثبيت .\n𓏸 𓇡 ** لست مشرف او لا املك صلاحيه التثبيت \n')    
end
end,nil)
end
return false
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 **ًأهلا عزيزي "..msg.TheRankCmd.."  \n𓏸 𓇡 ** تم الغاء تثبيت الرساله \n")    
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 **𓏸 𓇡 عذراً لا يمكنني الغاء التثبيت .\n𓏸 𓇡 ** لست مشرف او لا املك صلاحيه التثبيت \n')    
elseif data.ID == "Error" and data.code_ == 400 then
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** ًعذرا عزيزي '..msg.TheRankCmd..' .\n𓏸 𓇡 ** لا توجد رساله مثبته لاقوم بازالتها \n')    
end
end,nil)
end
return false
...
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** الرفع معطل \n")
end
return false
end
...
if not msg.Creator then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(bita..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(bita..'lock:kara:'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** أهلاً عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** الرفع معطل \n")
end
return false
end
...
if not msg.SudoUser then return "𓏸 𓇡 **هذا الامر يخص {المطور,المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "𓏸 𓇡 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
if not msg.Kara then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشى الاساسي فقط} فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
return "𓏸 𓇡 أهلاً عزيزي "..msg.TheRankCmd.." ↓\n𓏸 𓇡 تم تنزيل ❴ "..Admins.." ❵ من الادمنيه\n𓏸 𓇡 تم تنزيل ❴ "..NumMDER.." ❵ من المدراء\n𓏸 𓇡 تم تنزيل ❴ "..MMEZEN.." ❵ من المميزين\n\n𓏸 𓇡 تم تـنـزيـل الـكـل بـنـجـاح\n" 
end
...
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 **تم انشاء رابط جديد \n𓏸 𓇡 ["..LinkGp.."]\n𓏸 𓇡 لعرض الرابط ارسل { الرابط } \n")
else
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 لا يمكنني انشاء رابط للمجموعه .\n𓏸 𓇡 لانني لست مشرف في المجموعه \n")
end
else
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 لقد قمت بانشاء الرابط سابقا .\n𓏸 𓇡 ارسل { الرابط } لرؤيه الرابط  \n")
end
return false
end 
...
return '𓏸 𓇡 عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(bita..'linkGroup'..msg.chat_id_) then 
return "𓏸 𓇡 ** اوه لا يوجد رابط .\n𓏸 𓇡 **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
...
if not msg.Admin then return "𓏸 𓇡 *│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
local GroupLink = redis:get(bita..'linkGroup'..msg.chat_id_)
if not GroupLink then return "𓏸 𓇡 ** اوه لا يوجد هنا رابط\n𓏸 𓇡 *رجائا اكتب [ضع رابط]*" end
local Text = "𓏸 𓇡 رابـط الـمـجـمـوعه 𓏸 𓇡 \n"..Flter_Markdown(redis:get(bita..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if res == 403 then
return "𓏸 𓇡 **عذرا عزيزي \n𓏸 𓇡 لم استطيع ارسالك الرابط لانك قمت بحظر البوت\n!"
elseif res == 400 then
return "𓏸 𓇡 **عذرا عزيزي \n𓏸 𓇡 لم استطيع ارسالك الرابط يجب عليك مراسله البوت اولا \n!"
end
if res == 200 then 
return "𓏸 𓇡 **أهلاً عزيزي "..msg.TheRankCmd.."  \n𓏸 𓇡 تم ارسال الرابط خاص لك ."
end
end
...
return '𓏸 𓇡 حسننا عزيزي  .\n𓏸 𓇡 الان ارسل القوانين  للمجموعه .'
end

if MsgText[1] == "القوانين" then
if not redis:get(bita..'rulse:msg'..msg.chat_id_) then 
return "𓏸 𓇡 **مرحباً عزيري القوانين كلاتي .\n𓏸 𓇡 ممنوع نشر الروابط \n𓏸 𓇡 ممنوع التكلم او نشر صور اباحيه \n𓏸 𓇡 ممنوع  اعاده توجيه\n𓏸 𓇡 ممنوع التكلم بالسياسة \n𓏸 𓇡 الرجاء احترام المدراء والادمنيه\n"
else 
...
return "𓏸 𓇡 ** حدود التكرار ,  يجب ان تكون ما بين  *[2-50]*" 
end
redis:set(bita..'flood'..msg.chat_id_,MsgText[2]) 
return "𓏸 𓇡 ** تم وضع التكرار » { *"..MsgText[2].."* }"
end
...
if MsgText[2] and MsgText[2]:match('^%d+$') then
if not msg.Director then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if 500 < tonumber(MsgText[2]) then return "𓏸 𓇡 ** حدود المسح ,  يجب ان تكون ما بين  *[2-100]*" end
...
sendMsg(msg.chat_id_,msg.id_,"*𓏸 𓇡 * تـم مسح ←  { *"..MsgText[2].."* } من الرسائل  \n")
end,nil))
else
pcall(tdcli_function({ID="DeleteMessages",chat_id_=msg.chat_id_,message_ids_=All_Msgs},function() 
sendMsg(msg.chat_id_,msg.id_,"*𓏸 𓇡 * تـم مسح ←  { *"..MsgText[2].."* } من الرسائل  \n")
...
local Admins = redis:scard(bita..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "𓏸 𓇡 ** اوه هنالك خطأ .\n𓏸 𓇡 عذراً لا يوجد ادمنيه ليتم مسحهم ." 
end
redis:del(bita..'admins:'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم مسح {"..Admins.."} من الادمنيه في البوت \n"
end
...
if Mn3Word == 0 then 
return "𓏸 𓇡 ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(bita..':Filter_Word:'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم مسح {*"..Mn3Word.."*} كلمات من المنع"
end
...
if not msg.Director then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(bita..'rulse:msg'..msg.chat_id_) then 
return "𓏸 𓇡 عذراً لا يوجد قوانين ليتم مسحه \n!" 
end
redis:del(bita..'rulse:msg'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم حذف القوانين بنجاح"
end
...
return "𓏸 𓇡 ** اوه هنالك خطأ .\n𓏸 𓇡 عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(bita..'welcome:msg'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم حذف الترحيب بنجاح \n"
end
...
if not msg.Creator then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local NumMDER = redis:scard(bita..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "𓏸 𓇡 عذراً لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(bita..'owners:'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم مسح {* "..NumMDER.." *} من المدراء  \n"
end
...
if #list == 0 then return "*𓏸 𓇡 لا يوجد مستخدمين محظورين  *" end
message = '𓏸 𓇡 ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(bita..'banned:'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡  تم مسح {* "..#list.." *} من المحظورين  \n"
end
...
if MKTOMEN ==0 then 
return "𓏸 𓇡 ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(bita..'is_silent_users:'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم مسح {* "..MKTOMEN.." *} من المكتومين  \n"
end
...
local MMEZEN = redis:scard(bita..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*𓏸 𓇡 *لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(bita..'whitelist:'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم مسح {* "..MMEZEN.." *} من المميزين  \n"
end
...
if not msg.Director then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(bita..'linkGroup'..msg.chat_id_) then
return "*𓏸 𓇡 *لا يوجد رابط مضاف اصلا " 
end
redis:del(bita..'linkGroup'..msg.chat_id_)
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."   \n𓏸 𓇡 تم مسح رابط المجموعه \n"
end
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم مسح الصوره المجموعه .\n')
end
...
function(arg,data)
if data.ID == "Ok" then
--return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم تغيير صوره المجموعه ⠀\n')
elseif  data.code_ == 3 then
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ليس لدي صلاحيه تغيير الصوره \n𓏸 𓇡 يجب اعطائي صلاحيه `تغيير معلومات المجموعه ` ⠀\n')
end
end, nil)
end
...
return "𓏸 𓇡 حسننا عزيزي .\n𓏸 𓇡 الان ارسل الوصف  للمجموعه\n" 
end


if MsgText[1] == "طرد البوتات" then
if not msg.Director then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
tdcli_function({ID="GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''),
filter_ ={ID="ChannelMembersBots"},offset_ = 0,limit_ = 50},function(arg,data)
local Total = data.total_count_ or 0
if Total == 1 then
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 لا يـوجـد بـوتـات في الـمـجـمـوعـه .") 
else
local NumBot = 0
local NumBotAdmin = 0
...
local TextR  = "𓏸 𓇡 عـدد الـبـوتات 𓏸 𓇡⊱ {* "..(Total - 1).." *} ⊰𓏸 𓇡\n\n"
if NumBot == 0 then 
TextR = TextR.."𓏸 𓇡 لا يـمـكـن طردهم لانـهـم مشـرفـين .\n"
else
if NumBotAdmin >= 1 then
TextR = TextR.."𓏸 𓇡 لم يتم طـرد {* "..NumBotAdmin.." *} بوت لأنهم مـشـرفين."
else
TextR = TextR.."𓏸 𓇡 تم طـرد كــل البوتات بنجاح .\n"
end
end
...
filter_ ={ID= "ChannelMembersBots"},offset_ = 0,limit_ = 50},function(arg,data)
local total = data.total_count_ or 0
AllBots = '𓏸 𓇡 قـائمه البوتات الـحالية\n\n'
local NumBot = 0
for k, v in pairs(data.members_) do
...
𓏸 𓇡 لديك {]]..total..[[} بوتات
𓏸 𓇡 ملاحظة : الـ ♚ تعنـي ان البوت مشرف في المجموعـة.]]
...
if not msg.Creator then return "𓏸 𓇡 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 جارٍ البحث عن الحسابات المحذوفة ...')
tdcli_function({ID="GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100','')
...
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 تم طـرد {* "..NumMemDone.." *} من الحسابات المحذوفه‏‏ .")
else
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 لا يوجد حسابات محذوفه في المجموعه .')
end
end
end,nil)
end
...
local Get_info =  " \n𓏸 𓇡 ( الاحـصـائـيـات الـرسـائـلك )\n \n"
.."𓏸 𓇡 الـرسـائـل ( "..msgs.." )\n"
.."𓏸 𓇡 الـجـهـات ( "..NumGha.." )\n"
.."𓏸 𓇡 الـصـور ( "..photo.." )\n"
.."𓏸 𓇡 الـمـتـحـركـه ( "..animation.." )\n"
.."𓏸 𓇡 الـمـلـصـقات ( "..sticker.." )\n"
.."𓏸 𓇡 الـبـصـمـات ( "..voice.." )\n"
.."𓏸 𓇡 الـصـوت ( "..audio.." )\n"
.."𓏸 𓇡 الـفـيـديـو ( "..video.." )\n"
.."𓏸 𓇡 الـتـعـديـل ( "..edited.." )\n"
...
local msgs = redis:get(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if rfih == 0 then  return "𓏸 𓇡 **عذرا لا يوجد رسائل لك في البوت  ." end
redis:del(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "𓏸 𓇡 **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '𓏸 𓇡 **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "𓏸 𓇡 **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
return "𓏸 𓇡 **تم مسح {* "..adduser.." *} من جهاتك\n✓"
end
...
if points == 0 then  return "𓏸 𓇡 **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
return "𓏸 𓇡 **تم مسح {* "..points.." *} من نقاطك\n"
end
...
local Get_info ="𓏸 𓇡 اهلاً بك في معلوماتك . \n"
.."𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓\n"
.."𓏸 𓇡 الأسم ( "..FlterName(data.first_name_..' '..(data.last_name_ or ""),25).." )\n"
.."𓏸 𓇡 المعرف ( "..ResolveUser(data).." )\n"
.."𓏸 𓇡 الأيدي ( `"..msg.sender_user_id_.."` )\n"
.."𓏸 𓇡 رتبتك ( "..msg.TheRank.." )\n"
.."𓏸 𓇡 ـ ( `"..msg.chat_id_.."` )\n"
.."𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓\n"
.." 𓏸 𓇡 الأحصائيات الرسائل .\n"
.."𓏸 𓇡 الرسائل ( `"..msgs.."` )\n"
.."𓏸 𓇡 الجهات ( `"..NumGha.."` )\n"
.."𓏸 𓇡 الصور ( `"..photo.."` )\n"
.."𓏸 𓇡 المتحركه ( `"..animation.."` )\n"
.."𓏸 𓇡 الملصقات ( `"..sticker.."` )\n"
.."𓏸 𓇡 البصمات ( `"..voice.."` )\n"
.."𓏸 𓇡 الصوت ( `"..audio.."` )\n"
.."𓏸 𓇡 الفيديو ( `"..video.."` )\n"
.."𓏸 𓇡 التعديل (`"..edited.."` )\n"
...
local Get_info ="𓏸 𓇡 أهلاً عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
return "𓏸 𓇡 حسننا عزيزي .\n𓏸 𓇡 ارسل كليشه الترحيب الان\n\n𓏸 𓇡 ملاحظه تستطيع اضافه دوال للترحيب مثلا :\n𓏸 𓇡 أظهار قوانين المجموعه  » *{القوانين}*  \n𓏸 𓇡  أظهار الاسم العضو » *{الاسم}*\n𓏸 𓇡 أظهار المعرف العضو » *{المعرف}*\n𓏸 𓇡 أظهار اسم المجموعه » *{المجموعه}*" 
end
...
if not msg.SudoBase then return"𓏸 𓇡 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local mtwren = redis:scard(bita..':SUDO_BOT:')
if mtwren == 0 then  return "𓏸 𓇡 ** عذراً لا يوجد مطورين في البوت ." end
redis:del(bita..':SUDO_BOT:') 
return "𓏸 𓇡 ** تم مسح {* "..mtwren.." *} من المطورين .\n"
end
...
if addbannds ==0 then 
return "*𓏸 𓇡 قائمة الحظر فارغه .*" 
end
redis:del(bita..'gban_users') 
return "𓏸 𓇡 ** تـم مـسـح { *"..addbannds.." *} من قائمه العام\n" 
end 
...
if GroupDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** جـيـد , لا توجد مجموعات وهميه \n')
else
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** عدد المجموعات 𓏸 𓇡⊱ { *'..#groups..'*  } ⊰𓏸 𓇡\n𓏸 𓇡 ** تـم تنظيف  𓏸 𓇡⊱ { *'..GroupDel..'*  } ⊰𓏸 𓇡 مجموعه \n𓏸 𓇡 ** اصبح العدد الحقيقي الان 𓏸 𓇡⊱ { *'..GroupsIsFound..'*  } ⊰𓏸 𓇡 مجموعه')
end
end
end)
end
...
if #pv == i then 
if NumPvDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 جـيـد , لا يوجد مشتركين وهمي')
else
local SenderOk = #pv - NumPvDel
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** عدد المشتركين 𓏸 𓇡⊱ { *'..#pv..'*  } ⊰𓏸 𓇡\n𓏸 𓇡 ** تـم تنظيف  𓏸 𓇡⊱ { *'..NumPvDel..'*  } ⊰𓏸 𓇡 مشترك \n𓏸 𓇡 ** اصبح العدد الحقيقي الان 𓏸 𓇡⊱ { *'..SenderOk..'*  } ⊰𓏸 𓇡 من المشتركين') 
end
end
end)
end)
...
return'𓏸 𓇡 حسننا عزيزي .\n𓏸 𓇡 الان قم بارسال الصوره للترحيب \n' 
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[𓏸 𓇡 اهلا انا بوت]]..redis:get(bita..':NameBot:')..[[ .
𓏸 𓇡 اختصاصي حماية‌‏ المجموعات
𓏸 𓇡 مـن السبام والتوجيه‌‏ والتكرار والخ...

𓏸 𓇡 مـعـرف الـمـطـور  » ]]..SUDO_USER:gsub([[\_]],'_')..[[ .
]])

return false
else
return "𓏸 𓇡 لا توجد صوره مضافه للترحيب في البوت \n𓏸 𓇡 لاضافه صوره الترحيب ارسل `ضع صوره للترحيب`"
end
end

if MsgText[1] == "ضع كليشه المطور" then 
redis:setex(bita..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '𓏸 𓇡 حسننا عزيزي .\n𓏸 𓇡 الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(bita..':addnumberusers',MsgText[2]) 
return '𓏸 𓇡 ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'𓏸 𓇡 ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(bita..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "𓏸 𓇡 **هذا الامر يخص {المطور} فقط  \n" end
return '𓏸 𓇡 ** عدد المجموعات المفعلة » `'..redis:scard(bita..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "𓏸 𓇡 **هذا الامر يخص {المطور} فقط  \n" end
return '𓏸 𓇡 **عدد المشتركين في البوت : `'..redis:scard(bita..'users')..'` \n'
end

if MsgText[1] == 'قائمه المجموعات' then 
if not msg.SudoBase then return "𓏸 𓇡 **هذا الامر يخص {المطور} فقط  \n" end
...
sendMsg(MsgText[2],0,'𓏸 𓇡 ** تم تعطيل المجموعه بأمر من المطور  \n𓏸 𓇡 ** سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '𓏸 𓇡 ** تم تعطيل المجموعه ومغادرتها \n𓏸 𓇡 ** المجموعة » ['..name_gp..']\n𓏸 𓇡 ** الايدي » ( *'..MsgText[2]..'* )\n'
else 
return '𓏸 𓇡 ** لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 

if MsgText[1] == 'المطور' then
return redis:get(bita..":TEXT_SUDO") or '𓏸 𓇡 لا توجد كليشه المطور .\n𓏸 𓇡 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end
...
return "𓏸 𓇡 ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(bita..'fwd:'..msg.sender_user_id_,300, true) 
return "𓏸 𓇡 حسننا الان ارسل التوجيه للاذاعه \n" 
end
...
return "𓏸 𓇡 حسننا الان ارسل الكليشه للاذاعه عام \n" 
end
...
return "𓏸 𓇡 حسننا الان ارسل الكليشه للاذاعه خاص \n"
end
...
return "𓏸 𓇡 حسننا الان ارسل الكليشه للاذاعه للمجموعات \n" 
end
...
return "𓏸 𓇡 **هذا الامر يخص {المطور الاساسي} فقط  \n" 
end
...
if MsgText[1] == "رتبتي" then return '𓏸 𓇡 ** رتبتك ←  ( '..msg.TheRank..' )\n' end
...
return '𓏸 𓇡 ** تم إلغاء الأمر بنجاح .  \n'
end  
...
return '𓏸 𓇡 اصدار سورس بيتٲ : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس بيتٲ يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
return "𓏸 𓇡 ** ارسل ملف النسخه الاحتياطيه اولا\n𓏸 𓇡 ** ثم قم بالرد على الملف وارسل \" `رفع نسخه الاحتياطيه` \" "
end 
return false
end
...
if not msg.SudoBase then return"𓏸 𓇡 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return "𓏸 𓇡 البوت شـغــال ." 
end

if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي🆔") and msg.type == "pv" then return  "\n𓏸 𓇡 اهلاً عزيزي المطور ايديك :\n\n𓏸 𓇡 "..msg.sender_user_id_.."\n"  end
...
if not msg.SudoBase then return"𓏸 𓇡 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '𓏸 𓇡 الاحصائيات . \n\n𓏸 𓇡 **عدد المجموعات المفعله : '..redis:scard(bita..'group:ids')..'\n𓏸 𓇡 **عدد المشتركين في البوت : '..redis:scard(bita..'users')..'\n'
end
---------------[End Function data] -----------------------
...
return "𓏸 𓇡 حسننا الان ارسل كلمة الرد العام .\n"
end
...
return "𓏸 𓇡 تم مسح كل الردود ."
else
return '𓏸 𓇡 ** لا يوجد ردود ليتم مسحها \n'
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود العامه' then
if not msg.SudoBase then return"𓏸 𓇡 للمطورين فقط ." end
...
return "𓏸 𓇡 تم مسح كل الردود العامه ."
else
return "𓏸 𓇡 لا يوجد ردود عامه ليتم مسحها ."
end
end
...
return '𓏸 𓇡 **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '𓏸 𓇡 **ردود البوت في المجموعه  :\n\n'
...
if not msg.SudoBase then return "𓏸 𓇡 للمطور فقط ." end
...
local ii = 1
local message = '𓏸 𓇡 **الردود العامه في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *}_*( صوره ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *}_*( نص ) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *}_*( بصمه ) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *}_*( متحركه ) \n'ii = ii + 1 end
...
echo ' ( نظام التشغيل )\n*»» '"$linux_version"'*' 
echo '*------------------------------\n*𓏸 𓇡 ( الذاكره العشوائيه )\n*»» '"$memUsedPrc"'*'
echo '*------------------------------\n*𓏸 𓇡 ( وحـده الـتـخـزيـن )\n*»» '"$HardDisk"'*'
echo '*------------------------------\n*𓏸 𓇡 ( الـمــعــالــج )\n*»» '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
echo '*------------------------------\n*𓏸 𓇡 ❪ الــدخــول ❫\n*»» '`whoami`'*'
echo '*------------------------------\n*𓏸 𓇡( مـده تـشغيـل الـسـيـرفـر )  \n*»» '"$uptime"'*'
]]):read('*all')
end
...
↤︎ ‌‌‏الاوامر ↓
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 م1 ↤︎ اوامر الاداره‌‏
𓏸 𓇡 م2 ↤︎ اوامر اعدادات المجموعه‌‏
𓏸 𓇡 م3 ↤︎ اوامر الحماية‌‏
𓏸 𓇡 م4 ↤︎ اوامر الخدمه 
𓏸 𓇡 م5 ↤︎ اوامر التسليه
𓏸 𓇡 م6 ↤︎ اوامر التعطيل و التفعل
𓏸 𓇡 م7 ↤︎ اوامر الوضع للمجموعه
𓏸 𓇡 م المطور ↤︎  اوامر المطور
𓏸 𓇡 اوامر الرد ↤︎ الاظافة‌‏ رد معين
𓏸 𓇡 الوسائط ↤︎ لمعرفه الاعدادات 
𓏸 𓇡 الاعدادات ↤︎ عدادات المجموعه
𓏸 𓇡 سورس ↤︎ سورس البوت
𓏸 𓇡 المطور ↤︎ مطور البوت
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
 ‏‎‏𓏸 𓇡 معـرف المـطور ↤︎{ ]]..SUDO_USER..[[ } ✓ ]]
end
...
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 رفع › تنزيل ❬المدير❭
𓏸 𓇡 رفع › تنزيل ❬ادمن❭ 
𓏸 𓇡 رفع › تنزيل ❬مميز❭ 
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
❬اوامر المسح❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡
�
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 ** تواصل معي للأسفسار  ↤︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
end
if MsgText[1]== "م المطور" then
if not msg.SudoBase then return "𓏸 𓇡 للمطور الاساسي فقط  🎖" end
local text = [[     
❬اوامـر المطـور❭ 
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 تفعيـل › ❬لتفعيل البوت ❭
𓏸 𓇡 تعطيل › ❬لتعطيل البوت ❭
𓏸 𓇡 رفع منشى › ❬رفع منشى بالبوت❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 اذاعه › ❬لنشر رساله لكل المجموعات❭
𓏸 𓇡 اذاعه خاص › ❬ لنشر رساله لكل المشتركين خاص❭
𓏸 𓇡 اذاعه عام › ❬لنشر رساله لكل المجموعات والخاص❭
𓏸 𓇡 اذاعه عام بالتوجيه › ❬لنشر منشور قناتك بابتوجيه للكل❭
𓏸 𓇡 تنظيف المجموعات›  ❬لمسح المجموعات الوهميه❭
تنظيف المشتركين › ❬لمسح المشتركين الوهميين❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 تحديث › ❬لتحديث ملفات البوت❭
𓏸 𓇡 تحديث السورس › ❬لتحديث السورس الى اصدار احدث❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 ** معـرف المـطور ↤︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
❬جميع اوامر الردود ❭
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 الردود › لعرض الردود المثبته
𓏸 𓇡 اضف رد › لأضافه رد جديد
𓏸 𓇡 مسح رد › الرد المراد مسحه
𓏸 𓇡 مسح الردود › لمسح كل الردود
𓏸 𓇡 الردود العامه › لمعرف الردود المثبته عام 
𓏸 𓇡 اضف رد عام › لاضافه رد لكل المجموعات
𓏸 𓇡 مسح رد عام  › لمسح الرد العام 
𓏸 𓇡 مسح الردود العامه › لمسح كل ردود العامه
𓈓𓈓𓈓𓈓𓈓𓈓𓈓𓈓
𓏸 𓇡 ** معـرف المـطور ↤︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(bita..'lave_me'..msg.chat_id_) 
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "𓏸 𓇡 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𓏸 𓇡 " end
if redis:get(bita..'lave_me'..msg.chat_id_) then 
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(bita..'lave_me'..msg.chat_id_,true)  
return "𓏸 𓇡 **أهلا عزيزي "..msg.TheRankCmd.."\n𓏸 𓇡 ** تم تعطيل المغادره من قبل البوت\n✓" 
end   
end

if MsgText[1] == "اطردني" or MsgText[1] == "احظرني" then
if not redis:get(bita..'lave_me'..msg.chat_id_) then
if msg.Admin then return "𓏸 𓇡 **لا استطيع طرد المدراء والادمنيه والمنشئين  \n𓏸 𓇡 " end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"𓏸 𓇡 أهلاً عزيزي , لقد تم طردك من المجموعه بامر منك \n𓏸 𓇡 اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n𓏸 𓇡 فهذا رابط المجموعه\n𓏸 𓇡 "..Flter_Markdown(redis:get(bita..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(bita..'linkGroup'..msg.chat_id_).."]\n")
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 لقد تم طردك بنجاح , ارسلت لك رابط المجموعه في الخاص اذا وصلت لك تستطيع الرجوع متى شئت ")
else
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡  لا استطيع طردك لانك مشرف في المجموعه  ")
end
end)
return false
end
...
return [[
𓏸 𓇡 [ 𝙱𝙸𝚃𝙰 𝙲𝙷𝙰𝙽𝙴𝙻 ⁦](t.me/baselabaza)

𓏸 𓇡 [𝙳𝙴𝚅](t.me/xb_0b)

𓏸 𓇡 [ 𝚃𝚆𝙰𝚂𝙾𝙻 💬](t.me/abazaxbot)
...
return "\n𓏸 𓇡  الـتـاريـخ : "..os.date("%Y/%m/%d")
end

if MsgText[1]== "سحكاتي" then
return '𓏸 𓇡 **عدد سحكاتك ⇜ ❪ '..(redis:get(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "𓏸 𓇡 *│* لا يوجد سحكات لك في البوت ." end
redis:del(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
return "𓏸 𓇡 *│*تم مسح {* "..rfih.." *} من سحكاتك .\n"
end

if MsgText[1] == "تفعيل الاشتراك الاجباري" or MsgText[1] == "تفعيل الاشتراك الاجباري ☑" then
if not msg.SudoBase then return"𓏸 𓇡 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(bita..":UserNameChaneel") then
return "𓏸 𓇡 اهلا عزيزي المطور \n𓏸 𓇡 الاشتراك بالتأكيد مفعل"
else
redis:setex(bita..":ForceSub:"..msg.sender_user_id_,350,true)
return "𓏸 𓇡 مرحبا بـك في نظام الاشتراك الاجباري\n𓏸 𓇡 الان ارسل معرف قـنـاتـك"
end
if Text == "الغاء" then 
...
if SubDel == 1 then
return "𓏸 𓇡 تم تعطيل الاشتراك الاجباري . \n✓"
else
return "𓏸 𓇡 الاشتراك الاجباري بالفعل معطل . \n✓"
end
end
...
if UserChaneel then
return "𓏸 𓇡 اهلا عزيزي المطور \n𓏸 𓇡 الاشتراك الاجباري للقناة : ["..UserChaneel.."]\n"
else
return "𓏸 𓇡 لا يوجد قناة مفعله على الاشتراك الاجباري . \n"
end
end
...
txt = '𓏸 𓇡 اهلآ عزيزي '..(Diamond.first_name_ or '---')..'\n𓏸 𓇡 المجموعه  '..(data.title_ or '---')..' \n𓏸 𓇡 احترام الادمنيه\n𓏸 𓇡 ممنوع طلب الرتب\n𓏸 𓇡 ممنوع السب \n𓏸 𓇡 ممنوع التكلم بالسياسة\n𓏸 𓇡 الاعضاء '..mrr619.member_count_..' عضو\n𓏸 𓇡 الادمنيه '..mrr619.administrator_count_..' \n𓏸 𓇡 وقت الانضمام :【*'..os.date("%H:%M:%S")..'*】\n𓏸 𓇡 تاريخ الانضمام :【*'..os.date("%Y/%m/%d")..'*】\n'
...
if not msg.Kara then return "𓏸 𓇡 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(black,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 الأسم : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n𓏸 𓇡 تم رفعه مشرف بكامل الصلاحيات\n‌‏')
...
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 اهلا عزيزي \n𓏸 𓇡 تم تثبيت الامر الجديد\n✓')
...
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 اهلا بك عزيزي\n𓏸 𓇡 الامر الي تريد تغيره الي  "'..cmd..'" \n𓏸 𓇡 ارسله الان\n')
end
...
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 عزيزي المستخدم\n𓏸 𓇡 الامر فقط للصوره\n')
end
end
...
sendMsg(msg.chat_id_, msg.id_,' ✸∫ انت منشئ الكروب') 
return false
end
...
sendMsg(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
sendMsg(msg.chat_id_, msg.id_,' ✸∫ انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
...
return sendMsg(msg.chat_id_,0,'*𓏸 𓇡 * تم حظرك من البوت بسبب التكرار \n') 
end
...
text = [[𓏸 𓇡 أهلاً انا بوت   []]..redis:get(bita..':NameBot:')..[[] 
𓏸 𓇡 اختـصاصـي حمايـة الـمجموعات
𓏸 𓇡من التكـرار والسـبام وبوتـات التفـليش ومـن الشـير الايرانـي والخ
𓏸 𓇡فقط اضف للبوت لمجموعتك وارفعه مشرف واكتب تفعيل ▧
[قنـاة سورس بيتآ ᪤](t.me/baselabaza)

𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡
 𓏸 𓇡 مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
else
text = [[𓏸 𓇡 أهلاً انا بوت    []]..redis:get(bita..':NameBot:')..[[] 
𓏸 𓇡 اختـصاصـي حمايـة الـمجموعات
...
SendMention(msg.sender_user_id_,data.id_,msg.id_,"𓏸 𓇡 تم ارسال الرسالة .\n𓏸 𓇡 إلى : "..USERNAME.." .",39,USERCAR) 
return false 
end,nil)
end  
end,nil)
...
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 عذراً لا يمكنك ارسال { توجيه‌‏ , ملصق , فديو كام} .")
return false
end
redis:setex(bita.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 تم آرسـآل رسالتك إلى المطور\n𓏸 𓇡 سـآرد عليك في اقرب وقت ممكن \n𓏸 𓇡 معرف المطور "..SUDO_USER)
...
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه صوره للرد بنجاح\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(bita..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه بصمه صوت للرد بنجاح\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(bita..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه متحركه للرد بنجاح\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(bita..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه فيديو للرد بنجاح\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(bita..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه للصوت للرد بنجاح\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(bita..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(bita..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه ملصق للرد بنجاح\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الملصق الاتي ')
end  
...
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  𓏸 𓇡 تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(bita..'replay_photo:group:',klma,photo_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه صوره للرد العام\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(bita..'replay_voice:group:',klma,voice_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه بصمه صوت للرد العام\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(bita..'replay_animation:group:',klma,animation_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه متحركه للرد العام\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(bita..'replay_video:group:',klma,video_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه فيديو للرد العام\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(bita..'replay_audio:group:',klma,audio_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه للصوت للرد العام\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(bita..'replay_sticker:group:',klma,sticker_id)
redis:del(bita..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم اضافه ملصق للرد العام\n𓏸 𓇡 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الملصق الاتي ')
end  
...
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 عذراً , هناك خطأ لديك \n𓏸 𓇡 المعرف الذي ارسلته ليس معرف قناة.")
return false
elseif Req.description == "Bad Request: CHAT_ADMIN_REQUIRED" then
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 عذراً , لقد نسيت شيئا \n𓏸 𓇡 يجب رفع البوت مشرف في قناتك لتتمكن من تفعيل الاشتراك الاجباري .")
return false
end
else
redis:set(bita..":UserNameChaneel",msg.text)
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 جـيـد , الان لقد تم تفعيل الاشتراك الاجباري\n𓏸 𓇡 على قناتك ⇜ ["..msg.text.."]")
return false
end
else
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 عذرا , عزيزي المطور \n𓏸 𓇡 هذا ليس معرف قناة , حاول مجددا .")
return false
end
end
...
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 تم تغير اسم البوت  .\n𓏸 𓇡 الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end
...
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 جيد , يمكنك الان ارسال جوا ب الردالعام \n𓏸 𓇡 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 **هذا الرد ليس مضاف في قائمه الردود .')
else
...
return sendMsg(msg.chat_id_,msg.id_, "𓏸 𓇡 ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
...
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 ** مرحبآ عزيزي\n𓏸 𓇡 تم حفظ القوانين بنجاح .\n𓏸 𓇡 ارسل [[ القوانين ]] لعرضها \n')
end
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم وضع الرابط الجديد بنجاح .. 🍂')
end
...
if data.ID == "Ok" then 
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** تم وضع الوصف بنجاح\n")
end 
end,nil)
end
...
if allgp >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 اهلا عزيزي المطور \n𓏸 𓇡 جاري نشر التوجيه للمجموعات وللمشتركين ...')			
end
for i = 1, #pv do 
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 **تم اذاعه الكليشه بنجاح .\n𓏸 𓇡 **للمجموعات » ( *'..#groups..'* )\n𓏸 𓇡 ** للمشتركين » ( '..#pv..' )\n')
end
...
local pv = redis:smembers(bita..'users')
if #pv >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 اهلا عزيزي المطور \n𓏸 𓇡 جاري نشر الرساله للمشتركين ...')			
end
local NumPvDel = 0
for i = 1, #pv do
sendMsg(pv[i],0,Flter_Markdown(msg.text),nil,function(arg,data)
...
if #pv == i then 
local SenderOk = #pv - NumPvDel
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 **عدد المشتركين : ❴ '..#pv..' ❵\n𓏸 𓇡 **تم الاذاعه الى ❴ '..SenderOk..'  ❵ مشترك \n') 
end
end)
end
end
...
sendMsg(msg.chat_id_,msg.id_,'*¦* عدد المجموعات 𓏸 𓇡⊱ { *'..#groups..'*  } ⊰𓏸 𓇡\n*¦* تـم الاذاعه بالتثبيت بنجاح ')
end 
...
local groups = redis:smembers(bita..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 اهلا عزيزي المطور \n𓏸 𓇡 جاري نشر الرساله للمجموعات ...')			
end
local NumGroupsDel = 0
for i = 1, #groups do 
sendMsg(groups[i],0,Flter_Markdown(msg.text),nil,function(arg,data)
...
MsgTDel = '𓏸 𓇡 **تم حذف ❴ *'..NumGroupsDel..'* ❵ من قائمه الاذاعه لانهم قامو بطرد البوت من المجموعه'
else
MsgTDel = ''
end
sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 **عدد المجموعات ❴ *'..#groups..'* ❵\n𓏸 𓇡 **تـم الاذاعه الى ❴ *'..AllGroupSend..'* ❵\n'..MsgTDel..'')
end
end)
end
end 
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(bita..':WELCOME_BOT'),[[𓏸 𓇡أهلاً انا بوت ]]..redis:get(bita..':NameBot:')..[[
𓏸 𓇡 أختصاصي حماية‌‏ المجموعات
𓏸 𓇡 مـن السبام والتوجيه‌‏ والتكرار والخ...
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 **تم اذاعه التوجيه بنجاح .\n𓏸 𓇡 **للمجموعات » ❴ *'..#groups..'* ❵\n𓏸 𓇡 **للخاص » ❴ '..#pv..' ❵\n')			
end
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 
...
sendMsg(arg.chat_id_,arg.id_,'𓏸 𓇡 ليس لدي صلاحيه تغيير الصوره \n𓏸 𓇡 يجب اعطائي صلاحيه `تغيير معلومات المجموعه ` ⠀\n')
end
...
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 جيد , يمكنك الان ارسال جواب الرد \n𓏸 𓇡 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end
...
function(arg,data)
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** ًعذرا التثبيت مقفل من قبل الاداره تم ارجاع التثبيت القديم\n")
end
end,nil)
else
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 ** ًعذرا التثبيت مقفل من قبل الاداره تم الغاء التثبيت\n")      
end
end,nil)
end
return false
...
return sendMsg(msg.chat_id_,msg.id_,"𓏸 𓇡 قام  ["..UserName.."]\n𓏸 𓇡 بتغير اسم المجموعه .\n𓏸 𓇡 الى "..Flter_Markdown(msg.content_.title_).." \n") 
end)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(bita..'welcome:msg'..msg.chat_id_) or "𓏸 𓇡 اهلاً عزيزي {الاسم}\n𓏸 𓇡 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\n𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡\n𓏸 𓇡 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(bita..'rulse:msg'..msg.chat_id_) or "𓏸 𓇡 مرحباً عزيري القوانين كلاتي .\n𓏸 𓇡 ممنوع نشر الروابط\n𓏸 𓇡 ممنوع التكلم او نشر صور اباحيه\n𓏸 𓇡 ممنوع  اعاده توجيه\n𓏸 𓇡 ممنوع التكلم بالسياسة\n𓏸 𓇡 الرجاء احترام المدراء والادمنيه .\n")
...
welcome = (redis:get(bita..'welcome:msg'..msg.chat_id_) or "𓏸 𓇡 اهلن بك عزيزي {الاسم}\n𓏸 𓇡 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\n𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡\n𓏸 𓇡 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(bita..'rulse:msg'..msg.chat_id_) or "𓏸 𓇡 مرحباً عزيري القوانين كلاتي .\n𓏸 𓇡 ممنوع نشر الروابط\n𓏸 𓇡 ممنوع التكلم او نشر صور اباحيه\n𓏸 𓇡 ممنوع  اعاده توجيه\n𓏸 𓇡 ممنوع التكلم بالسياسة\n𓏸 𓇡 الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"𓏸 𓇡 العضو » "..USERNAME.."\n𓏸 𓇡 قمـت بتكرار اكثر مـن "..NUM_MSG_bita.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 صلاحياته منشئ القروب\n')   
end 
if Json_Info.result.status == "member" then
return sendMsg(msg.chat_id_,msg.id_,'𓏸 𓇡 مجرد عضو هنا\n')   
end 
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
info = 'ꪜ' else info = '✘' end
...
if Json_Info.result.can_promote_members == true then
promote = 'ꪜ' else promote = '✘' end
return sendMsg(chat,msg.id_,'𓏸 𓇡 الرتبة : مشرف\n𓏸 𓇡 والصلاحيات هي ↓ \n𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡\n𓏸 𓇡 تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n𓏸 𓇡 حذف الرسائل ↞ ❪ '..delete..' ❫\n𓏸 𓇡 حظر المستخدمين ↞ ❪ '..restrict..' ❫\n𓏸 𓇡 دعوة مستخدمين ↞ ❪ '..invite..' ❫\n𓏸 𓇡 تثبيت الرسائل ↞ ❪ '..pin..' ❫\n𓏸 𓇡 اضافة مشرفين جدد ↞ ❪ '..promote..' ❫\n\n𓏸 𓇡 ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𓏸 𓇡 ع
��� 𓍿 𓎀 𓎁 𓎂 𓎃 𓎄 𓎅 𓎆 𓎇 𓎈 𓎉 𓎊 𓎋 𓎌 𓎍 𓎎 𓎏 𓎐 𓎑 𓎒 𓎓 𓎔 𓎕 𓎖 𓎗 𓎘 𓎙 𓎚 𓎛 𓎜 𓎝 𓎞 𓎟 𓎠 𓎡 𓏋 𓏌 𓏍 𓏎 𓏏 𓏐 𓏑 𓏒 𓏓 𓏕 𓏖 𓏗 𓏘 𓏙 𓏚 𓏛 𓏜 𓏝 𓏞 𓏟 𓏠 𓏡 𓏢 𓏣 𓏤 𓏥 𓏦 𓏧 𓏨 𓏩 𓏪 𓏫 𓏬 𓏭 𓏮 𓏯 𓏰 𓏱 𓏲 𓏳 𓏴 𓏶 𓏷 𓏸 𓇡 𓏹 𓏺 𓏻 \n☆")
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡\n𓏸 𓇡 مرحباً عزيزي\n𓏸 𓇡 هذي اوامر التسليه:  \n𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡\n𓏸 𓇡 رفع › تنزيل ❬ متوحد ❭\n𓏸 𓇡 رفع › تنزيل ❬ وتكه ❭\n𓏸 𓇡 رفع › تنزيل ❬ غبي ❭\n𓏸 𓇡 رفع › تنزيل ❬ كلب ❭\n𓏸 𓇡 رفع › تنزيل ❬ حمار ❭\n𓏸 𓇡 رفع › تنزيل ❬ زوجتي ❭\n𓏸 𓇡 رفع › تنزيل ❬ متوحده ❭\n𓏸 𓇡 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\n𓏸 𓇡 ❬ طلاق ❭ › ❬ زواج ❭\n𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡𓏸 𓇡")
  ...
  return sendMsg(msg.chat_id_,msg.id_,[[
  𓏸 𓇡 رابط حذف حساب التليجرام
𓏸 𓇡 [أضغط هُنا](https://telegram.org/deactivate) - .
‏
  ]] )
  --=====================================
...
if not redis:get('kar') then
  ...
  Save_Data:close()
  sendDocument(SUDO_ID,0,"./inc/"..Bot_User..".json","𓏸 𓇡 ملف نسخه تلقائيه\n𓏸 𓇡   اليك مجموعاتك » { "..#All_Groups_ID.." }\n𓏸 𓇡 للبوت » "..Bot_User.."\n𓏸 𓇡 التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
  end
  if redis:get(bita..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(bita..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'𓏸 𓇡 انتهى الاشتراك في احد المجموعات .\n𓏸 𓇡 المجموعه : '..FlterName(redis:get(bita..'group:name'..msg.chat_id_))..'.\n𓏸 𓇡 ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'𓏸 𓇡 انتهى الاشتراك البوت.\n𓏸 𓇡 سوف اغادر المجموعه فرصه سعيده .\n𓏸 𓇡 او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(bita..'ExpireDate:'..msg.chat_id_) / 86400)
  if tonumber(DaysEx) > 0.208 and ExpireDate ~= -1 and msg.Admin then
  if tonumber(DaysEx + 1) == 1 and not msg.SudoUser then
  sendMsg(msg.chat_id_,'𓏸 𓇡 باقي يوم واحد وينتهي الاشتراك .\n𓏸 𓇡 راسل المطور للتجديد '..SUDO_USER..'\n')
  end 
  end 
  end
  end

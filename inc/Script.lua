...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/baselabaza/BITA/master/GetVersion.txt' ) or 0
...
send_key(msg.sender_user_id_,'  [• قناة سورس : بيتٲ](t.me/‏SourceMarten)',nil,inline,msg.id_)
return false
end
...
return [[
• [بــاســل ᐂ .](https://t.me/xb_0b)
• [عنتر .](https://t.me/AntarSidgi) 
...
elseif Text== "عنتر" or Text== "عنتر" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس](https://t.me/AntarSidgi)")
elseif Text== "ملك السيد" or Text== "ملوكي" then return  sendMsg(msg.chat_id_,msg.id_,"[هيِ‌ملاكِ‌وحارسِ‌ورفيقتي‌وحبيبًتي](https://t.me/Malakk222)")

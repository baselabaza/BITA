...
if redis:get(bita.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'• USE 𖥳 '..UserNameID..' .\n• MSG 𖦹 '..msgs..' .\n• STA 𖥳 '..msg.TheRank..' .\n• iD 𖦹 '..msg.sender_user_id_..' .',dl_cb,nil)
		else
...
local GetVerison = https.request( 'https://github.com/BITAFILE/bita.github/GetVersion.txt' ) or 0
...
return '• اصدار سورس مارتِن : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس مارتِن يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="• قناة‏‏ السورس أضغط هنا ",url="t.me/‏SourceMarten"}}}
send_key(msg.sender_user_id_,'  [• قناة سورس : مارتِن](t.me/‏SourceMarten)',nil,inline,msg.id_)
return false
end
...
return [[
• [𝐑𝐎𝐘 .](https://t.me/ISSSM)
• [مالك بِن عَتب🇸🇦 .](https://t.me/CZZZT) 
• [Source Marten](https://t.me/SourceMartn)
]]
end
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"• العضو » "..USERNAME.."\n• قمـت بتكرار اكثر مـن "..NUM_MSG_bita.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
elseif Text== "مالك" or Text== "مالك بن عتب" then return  sendMsg(msg.chat_id_,msg.id_,"[أعيناكَ حُباً أم الحُب شيئاً من عيناك .](https://t.me/CZZZT)")
elseif Text== "ارياند" or Text== "رهف" then return  sendMsg(msg.chat_id_,msg.id_,"[هيِ‌ملاكِ‌وحارسِ‌ورفيقتي‌وحبيبً‌وضلعي .](https://t.me/TlIlIl5)")
...
return sendMsg(msg.chat_id_,msg.id_,"[في زاوية صغيرة، بين الرغبة والعدم .](https://t.me/isssm) ")

...
users = redis:get(bita..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
return '-عزيزي قم برسال الرابط الجديد ... 𓈊'
end
...
return "↫تم مسح {* "..msgs.." *} من رسائلك  𓈊\n↯"
end

if MsgText[1]== 'جهاتي' then
return '↫  عدد جهآتك آلمـضـآفه‏‏ ⇜ ❪ '..(redis:get(bita..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n 𓈊'
end
...
if MsgText[2] == "ردود بيتا"   then return unlock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return unlock_brod(msg) end
if MsgText[2] == "ايدي بيتا"   then return unlock_IID(msg) end
if MsgText[2] == "ترحيب بيتا"  then return unlock_Welcome(msg) end
...
if MsgText[2] == "ردود بيتا"   then return lock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return lock_brod(msg) end
if MsgText[2] == "ايدي بيتا"   then return lock_IID(msg) end
if MsgText[2] == "ترحيب بيتا"  then return lock_Welcome(msg) end
...
return "↫ تم مسح {* "..mtwren.." *} من المطورين  𓈊\n↯"
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[-اهلا انابوت اسـمـي ]]..redis:get(bita..':NameBot:')..[[ ↯
-اختصـاصـي حمـاية المـجمـوعات
-مـن آلتفنيش والتوجيه‌‏ والتكرار وغيره...

-مـعـرف الـمـطـور  » ]]..SUDO_USER:gsub([[\_]],'_')..[[  𓈊
]])
...
return'↫ شـرط آلتفعيل آلبوت آذآكآنت آلمـجمـوعهہ‏‏ آكثر مـن *【'..redis:get(bita..':addnumberusers')..'】* عضـو  \n' 
end 
end
...
return '-اصدار سورس بيتا  : *v'..version..'* \n໑'
end
...
sendMsg(msg.chat_id_,msg.id_,'↫ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس بيتا يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❗️')
end  
else
...
send_key(msg.sender_user_id_,'  [-قناة سورس : بيتا ل](https://t.me/baselabaza)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"-للمطورين فقط !  𓈊" end
...
if not msg.SudoBase then return "-للمطور فقط !  𓈊" end
...
[مسارات الاوامر العامه]
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ᵜ م1 ↤ اوامر الإداره .‌‏
  ᵜ م2 ↤ اوامر اعدادات المجمّوعه .‌‏
    ᵜ م3 ↤ اوامر الحِمايـه .
    ᵜ م4 ↤ اوامر الخِدمـه .
    ᵜ م5 ↤ اوامر التسـليه .
  ᵜ م6 ↤ اوامر التعَطيل و التفَعيل .
    ᵜ م7 ↤ اوامر الوضع للمجموعه .
    ᵜ م المطور ↤ اوامر آلمـطـور .
  ᵜ   اوامر الرد ↤ لاضـافة‌‏ رد مـعين .
    ᵜ الوسائط ↤ لمعرفه الاعدادات 
    ᵜ الاعدادات ↤ اعدادات المجموعه .
    ᵜ السورس ↤ سورس البوت
    ᵜ المطور  ↤ مطور البوت
   ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
...
ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ...
  ᵜ رفع ↝↜ تنزيل مميز .
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
   ٢ ᵜ اوامـر المسح للمنشئ .
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ᵜ مسح الادمنـيـه ↤ لمسح الادمنيه
  ᵜ مسح المميزين ↤ لمسح المميزين 
  ᵜ مسح المـــدراء ↤ لمسح المدراء 
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ٣ ᵜ اوامـر الحظـر والطــرد والتقييد .
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ᵜ حظر بالرد ↝↜ بالمعرف ↤ لحظر العضو
  ᵜ الغاء الحظر بالرد ↝↜ بالمعرف ↤ لالغاء الحظر 
  ᵜ طرد بالرد ↝↜ بالمعرف ↤ لطرد العضو
  ᵜ كتم بالرد ↝↜ بالمعرف ↤ لكتم العضو 
  ᵜ الغاء الكتم بالرد ↝↜ بالمعرف ↤ لالغاء الكتم 
   ᵜ تقييد بالرد  ↝↜ بالمعرف ↤ لتقييد العضو
  ᵜ فك التقييد  بالرد ↝↜ بالمعرف ↤ لالغاء تقييد العضو
   ᵜ منع + الكلمه  ↤ لمنع الكلمه
  ᵜ الغاء منع ↤ لالغاء منع الكلمه
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
يـوزر المّـطور ⇦  ]]..SUDO_USER
...
local text = [[
ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
   ᵜ الـرابـط ↤ لعرض الرابط 
   ᵜ انشاء رابط ↤ لِستخراج رابط جديد 
   ᵜ الادمنيه ↤ لعرض الادمنيه
   ᵜ القوانين ↤ لعرض القوانين 
   ᵜ الوسائط ↤ لعرض اعدادات الميديا
   ᵜ الحمايـه ↤ لعرض كل الاعدادات
 ᵜ المــدراء ↤ لعرض الاداريين
 ᵜ المكتومين ↤ لعـرض المكتومين 
 ᵜ المحظورين ↤ لعرض المحظورين
 ᵜ الاعدادات ↤ لعرض اعدادات المجموعه 
 ᵜ المجموعه ↤ لعرض معلومات المجموعه
 ᵜ تغير امر + الامر ↤ لتغير اوامر البوت 
   ᵜ مسح امر + الامر ↤ لمسح الامر المضاف
 ᵜ قائمـه الاوامر ↤ لمعرفه الاوامرالمضافه 
 ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
...
(اوامر حمايـه المجموعه)
 ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
   ᵜ قفل ↝↜ فتح ↤ الكُل 
   ᵜ قفل ↝↜ فتح ↤ التـاك
   ᵜ قفل ↝↜ فتح ↤ الفيـديـــو
   ᵜ قفل ↝↜ فتح ↤ الصــــــــور 
   ᵜ قفل ↝↜ فتح ↤ الملصقات
   ᵜ قفل ↝↜ فتح ↤ المتحركه
   ᵜ قفل ↝↜ فتح ↤ البصمــات
   ᵜ قفل ↝↜ فتح ↤ الدردشـــه
 ᵜ قفل ↝↜ فتح ↤ الــروابـــط
   ᵜ قفل ↝↜ فتح ↤ البـــوتــات
   ᵜ قفل ↝↜ فتح ↤ التعــديــل
   ᵜ قفل ↝↜ فتح ↤ المعرفــات
   ᵜ قفل ↝↜ فتح ↤ الكـــلايـش
   ᵜ قفل ↝↜ فتح ↤ التـــكـــــرار
   ᵜ قفل ↝↜ فتح ↤ الجــهـــــات
   ᵜ قفل ↝↜ فتح ↤ الانـــلايــن
   ᵜ قفل ↝↜ فتح ↤ التوجيــــه
   ᵜ قفل ↝↜ فتح ↤ الدخول بالرابط
   ᵜ قفل ↝↜ فتح ↤ البوتات بالطرد
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
   ٢ ᵜ القفل بالتقييـد
                                               
 ᵜ قفل ↝↜ فتح ↤ الــصــــــور بالتقييـد
   ᵜ قفل ↝↜ فتح ↤ الــروابــط بالتقييـد 
   ᵜ قفل ↝↜ فتح ↤ المتحركه بالتقييـد
   ᵜ قفل ↝↜ فتح ↤ الفيـــديــو بالتقييد
   ᵜ قفل ↝↜ فتح ↤ التوجيــه بالتقييــد
...
local text = [[
ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ 
  ᵜ ايـدي ↤ لعرض صورتك + معلوماتك
  ᵜ ايديـي  ↤ لعرض ايديك 
  ᵜ ايدي بالرد ↤ لعرض ايدي الشخص
  ᵜ الرابط  ↤ لظهور رابط المجموعه
  ᵜ جهاتي ↤ لمعرفه عدد جهاتك
  ᵜ الالعاب ↤ لعرض العاب البوت
  ᵜ نقاطي  ↤ لمعرفه عدد نقاطك
  ᵜ بيع نقاطي  + العدد ↤ لبيع نقاطك
  ᵜ معلوماتي ↤ لعرض معلوماتك
  ᵜ السورس  ↤ لعرض سورس البوت
  ᵜ الرتبه بالرد ↤ لمعرفه رتبه الشخص
  ᵜ التفاعل ↤ بالمعرف او بالرد لمعرفه تفاعل الشخص
  ᵜ كشف بالمعرف او بالرد ↤ لمعرفه معلومات حسابه
  ᵜ كشف البوتات ↤ لاظهار عدد البوتات الموجوده بالمجموعه
  ᵜ طرد البوتات ↤ لطرد كل البوتات
  ᵜ طرد المحذوفين ↤ لطرد الحسابات المحذوفه
  ᵜ رابط الحذف ↤ لحذف حساب التليجرام
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ 
...
local text =[[
 ...
 ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ᵜ تفعيل ↝↜ تعطيل ↤ الرفــع 
  ᵜ تفعيل ↝↜ تعطيل ↤ الردود 
  ᵜ تفعيل ↝↜ تعطيل ↤ الالعـاب
  ᵜ تفعيل ↝↜ تعطيل ↤ التحذير 
  ᵜ تفعيل ↝↜ تعطيل ↤ الترحيب 
  ᵜ تفعيل ↝↜ تعطيل ↤ الايدي 
  ᵜ تفعيل ↝↜ تعطيل ↤ الايدي بالصوره 
  ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
...
local text =[[
 ...
 ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
  ...
  ᵜ ضع رابـط ↤ لوضع رابط 
  ᵜ ضع اســـم ↤ لوضع اســم 
  ᵜ ضع صوره ↤ لوضع صوره 
  ᵜ ضع وصـف ↤ لوضع وصف 
  ᵜ ضع القوانيــن ↤ لوضع القوانين 
  ᵜ ضع الترحيب ↤ لوضع ترحيــب 
  ᵜ ضع تكرار +العدد ↤ لوضع تكرار 
...
if not msg.SudoBase then return "-للمطور الاساسي فقط   𓈊" end
local text = [[
ᵜ ᵜ ᵜ ᵜ  ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ ᵜ
- تفعيـل ⇦ (لتفعيل البوت )
- تعطيل ⇦ (لتعطيل البوت )
...
• قناة السورس «» ❬لمعرفة قناة السورس❭
...
return [[
ᵜ↜ مــطــور الــســورس  ⇦ [بــاســل ᐂ](t.me/xb_0b)
ᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜ
ᵜ↜ قــنــاة الـسـورس⇦ [ســورس بيتـا 𓈊.](t.me/baselabaza)
 𓂐
]]
end
...
return '↫عدد تعديلاتك ⇜ ❪ '..(redis:get(bita..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
return "↫تم مسح {* "..rfih.." *} من تعديلاتك  𓈊\n↯"
end
...
local colors = {'blue','green','yellow','magenta','Obaselabazae','DarkObaselabazae','red'}
...
text = [[-اهلاً انا بـوت اسـمي []]..redis:get(bita..':NameBot:')..[[] 𓈊
...
text = [[- اهلاً انابـوت اسمي []]..redis:get(bita..':NameBot:')..[[] 𓈊
-لحماية المجموعات من البوتات
والتوجيه‌‏ والتكرار وغيره...
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
 ⚖│مـعـرف الـمـطـــور ↫ ]]..SUDO_USER..[[
...
return sendMsg(msg.chat_id_,msg.id_,"•𓇼جيد , يمكنك الان ارسال جوا ب الردالعام \n•𓇼[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n↯")
end
end
...
return sendMsg(msg.chat_id_,msg.id_, "•𓇼** تم وضع الكليشه بنجاح كلاتي  𓈊\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n↯")
end
...
return sendMsg(msg.chat_id_,msg.id_,"↫ تم وضع الترحيب بنجاح كلاتي 𓇼\n↯" )
end
...
return sendMsg(msg.chat_id_,msg.id_,'-تم وضع الرابط الجديد بنجاح .. 𓇼')
end
...
return sendMsg(msg.chat_id_,msg.id_,'↫تم اذاعه الكليشه بنجاح 𓇼\n↫للمـجمـوعآت » ❴ *'..#groups..'* ❵ مجموعه \n↫ للمـشـترگين » ❴ '..#pv..' ❵ مشترگ \n↯')
end
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(bita..':WELCOME_BOT'),[[-اهلا انآ بوت آسـمـي ]]..redis:get(bita..':NameBot:')..[[ ↯
-لحمايةالمجموعات من التكرار والتوجيه وغيره .


• 𓈊مـعـرف الـمـطـور  : ]]..SUDO_USER:gsub([[\_]],'_')..[[ 🌿
]])
return false
end 
...
return sendMsg(msg.chat_id_,msg.id_,'-تم تغيير صـورة آلترحيب للبوت 𓇼\n↯')
end 
...
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'↫هذا الرد ليس مضاف في قائمه الردود 𓇼')
else
redis:hdel(bita..'replay:'..msg.chat_id_,msg.text)
redis:hdel(bita..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(bita..'replay_voice:group:'..msg.chat_id_,msg.text)
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(bita..'welcome:get'..msg.chat_id_) then
...
welcome = (redis:get(bita..'welcome:msg'..msg.chat_id_) or "- أهلاًً حبيبي\n-نورت المجموعة .")
welcome = welcome:gsub("{القوانين}", redis:get(bita..'rulse:msg'..msg.chat_id_) or "- الابتعاد عن الألفاظ القذرة.\n- الابتعاد عن العنصرية.\n- عدم نشر صور ومقاطع غير اخلاقية.\n- احترام مالك القروب واعضاء القروب.")
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"-العضو » "..USERNAME.."\n-قمـت بتكرآر آكثر مـن "..NUM_MSG_bita.." رسـآله‌‏ , لذآ تم تقييدك مـن آلمـجمـوعه‌‏  \n",12,USERCAR) 
return false
end)
end 
...
elseif Text== "ملك السيد" then return sendMsg(msg.chat_id_,msg.id_,"[كيف الحياة بدون عيونها♥](t.me/malakk222")
elseif Text== "رابط الحذف"  then return sendMsg(msg.chat_id_,msg.id_,"₪⇐ رابط حذف حساب التليقرام . 𖣐
(https://telegram.org/deactivate)[قم بالحذف من هنا .]

ᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜᵜ
⋆ قناة السورس   ⇽(http://t.me/baselabaza)[لا تتردد بالدخول 𖡛]

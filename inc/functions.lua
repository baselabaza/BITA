...
download_file('https://raw.githubusercontent.com/baselabaza/bita/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/baselabaza/bita/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/baselabaza/bita/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/baselabaza/bita/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(bita..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(bita..":NameBot:") or "الزعيم"
...
usernn = data.username_ or "baselabaza"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "baselabaza"
end
Name = Name:gsub('[[][]]','')
...
local Fshar_Word , res = https.request('https://api.th3bita.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3bita.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(bita..':MONSHA_Group:'..ChatID,UserID) then
var = ' المنشىء اساسي👷🏽' 
...
local Emsgs = redis:get(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
Replay = Replay:gsub("{البوت}",redis:get(bita..':NameBot:'))
...
local monshaas = redis:smembers(bita..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(bita..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(bita..'owners:'..msg.chat_id_)
local Admins = redis:smembers(bita..'admins:'..msg.chat_id_)
local mmez = redis:smembers(bita..'whitelist:'..msg.chat_id_)
...
message = message ..i.. '-l ['..info.username..'](t.me/baselabaza) \n'
end
...
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(bita..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
...
message = message ..k.. '-l ['..info.username..'](t.me/baselabaza) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
local monsha = redis:smembers(bita..':MONSHA_Group:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message ..k.. '-l ['..info.username..'](t.me/baselabaza) l » (`' ..v.. '`) \n'
end
end
end
...
local NumberFlood = tonumber(redis:get(bita..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(bita..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
local creator = redis:smembers(bita..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
bita..'num_msg_max'..id_group,
bita..'mute_text'..id_group,
bita..'admins:'..id_group,
bita..':Filter_Word:'..id_group,
bita..'banned:'..id_group,
bita..'is_silent_users:'..id_group,
bita..'whitelist:'..id_group,
bita..':MONSHA_BOT:'..id_group,
bita..'owners:'..id_group,
bita..'replay'..id_group,
bita..':MONSHA_Group:'..id_group
)
...
NumAdmin = NumAdmin + 1
if not redis:sismember(bita..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(bita..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(bita..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(bita..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n✓️') end
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(bita..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(bita..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
bita..'group:add'..arg.chat_id_,true,
bita..'lock_link'..arg.chat_id_,true, 
bita..'lock_id'..arg.chat_id_,true,
bita..'lock_spam'..arg.chat_id_,true,
bita..'lock_webpage'..arg.chat_id_,true,
bita..'lock_markdown'..arg.chat_id_,true,
bita..'lock_flood'..arg.chat_id_,true,
bita..'lock_bots'..arg.chat_id_,true,
bita..'mute_forward'..arg.chat_id_,true,
bita..'mute_contact'..arg.chat_id_,true,
bita..'mute_location'..arg.chat_id_,true,
bita..'mute_document'..arg.chat_id_,true,
bita..'mute_keyboard'..arg.chat_id_,true,
bita..'mute_game'..arg.chat_id_,true,
bita..'mute_inline'..arg.chat_id_,true,
bita..'lock_username'..arg.chat_id_,true,
bita..'num_msg_max'..arg.chat_id_,5, 
bita..'lock_edit'..arg.chat_id_,true,
bita..'replay'..arg.chat_id_,true,
bita..'lock_rdodSource'..arg.chat_id_,true,
bita.."lock_KickBan"..msg.chat_id_,true,
bita.."lock_mmno3"..msg.chat_id_,true,
bita.."lock_KickBan"..msg.chat_id_,true,
bita.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(bita..'group:ids',arg.chat_id_) 
redis:sadd(bita..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(bita..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(bita..'linkGroup'..arg.chat_id_,Gp_Link)
...
if cmd == "Upmonsh" then
if redis:sismember(bita..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(bita..'username:'..UserID,'username',USERNAME)
redis:sadd(bita..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(bita..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(bita..':MONSHA_Group:'..ChatID,UserID) 
...
if cmd == "upMshrf" then
redis:hset(bita..'username:'..UserID,'username',Resolv)
redis:setex(bita..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(bita..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
local edited = redis:get(bita..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(bita..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(bita..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(bita..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(bita..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(bita..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(bita..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(bita..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(bita..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(bita..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(bita..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(bita..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(bita..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(bita..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(bita..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(bita..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(bita..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(bita..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(bita..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(bita..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(bita..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(bita..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(bita..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(bita..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(bita..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(bita..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(bita..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(bita..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(bita..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(bita..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(bita..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(bita..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(bita..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(bita..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(bita..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(bita..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(bita..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(bita..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(bita..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(bita..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(bita..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(bita..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(bita.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(bita.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(bita.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(bita..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(bita..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(bita..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(bita..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(bita..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(bita..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(bita..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(bita..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(bita..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end

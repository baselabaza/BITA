...
return SendMention(ChatID,UserID,MsgID,'- العضو « ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n- الايدي « ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح مدير \n↯',17,USERCAR) 
end
...
redis:hset(bita..'username:'..UserID, 'username', UserName)
redis:sadd(bita..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو « ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n- **الايدي « ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح مدير \n↯')
end

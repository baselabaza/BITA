...
if redis:get(BITA..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
if not redis:get(BITA..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(BITA..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(BITA..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(BITA..'admins:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(BITA..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(BITA..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
.."\n• التاك «» "..(redis:get(BITA..'lock_tag'..msg.chat_id_) or 'false')
...
.."\n• الماركدوان «» "..(redis:get(BITA..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(BITA..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(BITA..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(BITA..'num_msg_BITA'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(BITA..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(BITA..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(BITA..'mute_inline'..msg.chat_id_) or 'false')
...
.."\n• البصمات «» "..(redis:get(BITA..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(BITA..'mute_voice'..msg.chat_id_) or 'false')
